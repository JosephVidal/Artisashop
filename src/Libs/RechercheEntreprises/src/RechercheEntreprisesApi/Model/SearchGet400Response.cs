...
namespace RechercheEntreprisesApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_search_get_400_response")]
    public partial class SearchGet400Response : IEquatable<SearchGet400Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchGet400Response" /> class.
        /// </summary>
        /// <param name="erreur">erreur.</param>
        public SearchGet400Response(string erreur = default(string))
        {
            this.Erreur = erreur;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SearchGet400Response {\n");
        ...
        {
            return this.Equals(input as SearchGet400Response);
        }

        /// <summary>
        /// Returns true if SearchGet400Response instances are equal
        /// </summary>
        /// <param name="input">Instance of SearchGet400Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchGet400Response input)
        {
            if (input == null)
            {
                return false;
