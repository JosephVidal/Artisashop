...
{
    /// <summary>
    /// V3InseeSireneUnitesLegalesDiffusiblesSirenGet200Response
    /// </summary>
    [DataContract(Name = "_v3_insee_sirene_unites_legales_diffusibles__siren__get_200_response")]
    public partial class V3InseeSireneUnitesLegalesDiffusiblesSirenGet200Response : IEquatable<V3InseeSireneUnitesLegalesDiffusiblesSirenGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InseeSireneUnitesLegalesDiffusiblesSirenGet200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3InseeSireneUnitesLegalesDiffusiblesSirenGet200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InseeSireneUnitesLegalesDiffusiblesSirenGet200Response" /> class.
        /// </summary>
        ...
        public V3InseeSireneUnitesLegalesDiffusiblesSirenGet200Response(V3InseeSireneUnitesLegalesDiffusiblesSirenGet200ResponseData data = default(V3InseeSireneUnitesLegalesDiffusiblesSirenGet200ResponseData), V3InseeSireneUnitesLegalesSirenGet200ResponseLinks links = default(V3InseeSireneUnitesLegalesSirenGet200ResponseLinks), V3InseeSireneEtablissementsSiretAdresseGet200ResponseMeta meta = default(V3InseeSireneEtablissementsSiretAdresseGet200ResponseMeta))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for V3InseeSireneUnitesLegalesDiffusiblesSirenGet200Response and cannot be null");
            }
            this.Data = data;
            // to ensure "links" is required (not null)
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for V3InseeSireneUnitesLegalesDiffusiblesSirenGet200Response and cannot be null");
            }
            this.Links = links;
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new ArgumentNullException("meta is a required property for V3InseeSireneUnitesLegalesDiffusiblesSirenGet200Response and cannot be null");
            }
            this.Meta = meta;
        }
        ...
        public V3InseeSireneUnitesLegalesDiffusiblesSirenGet200ResponseData Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name = "links", IsRequired = true, EmitDefaultValue = true)]
        public V3InseeSireneUnitesLegalesSirenGet200ResponseLinks Links { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3InseeSireneUnitesLegalesDiffusiblesSirenGet200Response {\n");
        ...
        {
            return this.Equals(input as V3InseeSireneUnitesLegalesDiffusiblesSirenGet200Response);
        }

        /// <summary>
        /// Returns true if V3InseeSireneUnitesLegalesDiffusiblesSirenGet200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of V3InseeSireneUnitesLegalesDiffusiblesSirenGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3InseeSireneUnitesLegalesDiffusiblesSirenGet200Response input)
        {
            if (input == null)
            {
                return false;
