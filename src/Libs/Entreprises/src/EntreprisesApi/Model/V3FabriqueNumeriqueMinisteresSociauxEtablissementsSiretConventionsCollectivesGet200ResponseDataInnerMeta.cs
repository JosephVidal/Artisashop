...
{
    /// <summary>
    /// V3FabriqueNumeriqueMinisteresSociauxEtablissementsSiretConventionsCollectivesGet200ResponseDataInnerMeta
    /// </summary>
    [DataContract(Name = "_v3_fabrique_numerique_ministeres_sociaux_etablissements__siret__conventions_collectives_get_200_response_data_inner_meta")]
    public partial class V3FabriqueNumeriqueMinisteresSociauxEtablissementsSiretConventionsCollectivesGet200ResponseDataInnerMeta : IEquatable<V3FabriqueNumeriqueMinisteresSociauxEtablissementsSiretConventionsCollectivesGet200ResponseDataInnerMeta>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3FabriqueNumeriqueMinisteresSociauxEtablissementsSiretConventionsCollectivesGet200ResponseDataInnerMeta" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3FabriqueNumeriqueMinisteresSociauxEtablissementsSiretConventionsCollectivesGet200ResponseDataInnerMeta() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3FabriqueNumeriqueMinisteresSociauxEtablissementsSiretConventionsCollectivesGet200ResponseDataInnerMeta" /> class.
        /// </summary>
        /// <param name="internalId">Identifiant interne (DILA) de la convention (required).</param>
        public V3FabriqueNumeriqueMinisteresSociauxEtablissementsSiretConventionsCollectivesGet200ResponseDataInnerMeta(string internalId = default(string))
        {
            // to ensure "internalId" is required (not null)
            if (internalId == null)
            {
                throw new ArgumentNullException("internalId is a required property for V3FabriqueNumeriqueMinisteresSociauxEtablissementsSiretConventionsCollectivesGet200ResponseDataInnerMeta and cannot be null");
            }
            this.InternalId = internalId;
        }

        /// <summary>
        /// Identifiant interne (DILA) de la convention
        /// </summary>
        /// <value>Identifiant interne (DILA) de la convention</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3FabriqueNumeriqueMinisteresSociauxEtablissementsSiretConventionsCollectivesGet200ResponseDataInnerMeta {\n");
        ...
        {
            return this.Equals(input as V3FabriqueNumeriqueMinisteresSociauxEtablissementsSiretConventionsCollectivesGet200ResponseDataInnerMeta);
        }

        /// <summary>
        /// Returns true if V3FabriqueNumeriqueMinisteresSociauxEtablissementsSiretConventionsCollectivesGet200ResponseDataInnerMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of V3FabriqueNumeriqueMinisteresSociauxEtablissementsSiretConventionsCollectivesGet200ResponseDataInnerMeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3FabriqueNumeriqueMinisteresSociauxEtablissementsSiretConventionsCollectivesGet200ResponseDataInnerMeta input)
        {
            if (input == null)
            {
                return false;
