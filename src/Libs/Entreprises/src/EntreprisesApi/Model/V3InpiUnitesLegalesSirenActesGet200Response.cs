...
{
    /// <summary>
    /// V3InpiUnitesLegalesSirenActesGet200Response
    /// </summary>
    [DataContract(Name = "_v3_inpi_unites_legales__siren__actes_get_200_response")]
    public partial class V3InpiUnitesLegalesSirenActesGet200Response : IEquatable<V3InpiUnitesLegalesSirenActesGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InpiUnitesLegalesSirenActesGet200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3InpiUnitesLegalesSirenActesGet200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InpiUnitesLegalesSirenActesGet200Response" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public V3InpiUnitesLegalesSirenActesGet200Response(List<V3InpiUnitesLegalesSirenActesGet200ResponseDataInner> data = default(List<V3InpiUnitesLegalesSirenActesGet200ResponseDataInner>))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for V3InpiUnitesLegalesSirenActesGet200Response and cannot be null");
            }
            this.Data = data;
        }
        ...
        public List<V3InpiUnitesLegalesSirenActesGet200ResponseDataInner> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3InpiUnitesLegalesSirenActesGet200Response {\n");
        ...
        {
            return this.Equals(input as V3InpiUnitesLegalesSirenActesGet200Response);
        }

        /// <summary>
        /// Returns true if V3InpiUnitesLegalesSirenActesGet200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of V3InpiUnitesLegalesSirenActesGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3InpiUnitesLegalesSirenActesGet200Response input)
        {
            if (input == null)
            {
                return false;
