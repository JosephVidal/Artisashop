...
{
    /// <summary>
    /// V3InseeSireneEtablissementsSiretAdresseGet200Response
    /// </summary>
    [DataContract(Name = "_v3_insee_sirene_etablissements__siret__adresse_get_200_response")]
    public partial class V3InseeSireneEtablissementsSiretAdresseGet200Response : IEquatable<V3InseeSireneEtablissementsSiretAdresseGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InseeSireneEtablissementsSiretAdresseGet200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3InseeSireneEtablissementsSiretAdresseGet200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InseeSireneEtablissementsSiretAdresseGet200Response" /> class.
        /// </summary>
        ...
        public V3InseeSireneEtablissementsSiretAdresseGet200Response(V3InseeSireneEtablissementsSiretAdresseGet200ResponseData data = default(V3InseeSireneEtablissementsSiretAdresseGet200ResponseData), V3InseeSireneEtablissementsSiretAdresseGet200ResponseLinks links = default(V3InseeSireneEtablissementsSiretAdresseGet200ResponseLinks), V3InseeSireneEtablissementsSiretAdresseGet200ResponseMeta meta = default(V3InseeSireneEtablissementsSiretAdresseGet200ResponseMeta))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for V3InseeSireneEtablissementsSiretAdresseGet200Response and cannot be null");
            }
            this.Data = data;
            // to ensure "links" is required (not null)
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for V3InseeSireneEtablissementsSiretAdresseGet200Response and cannot be null");
            }
            this.Links = links;
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new ArgumentNullException("meta is a required property for V3InseeSireneEtablissementsSiretAdresseGet200Response and cannot be null");
            }
            this.Meta = meta;
        }
        ...
        public V3InseeSireneEtablissementsSiretAdresseGet200ResponseData Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name = "links", IsRequired = true, EmitDefaultValue = true)]
        public V3InseeSireneEtablissementsSiretAdresseGet200ResponseLinks Links { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3InseeSireneEtablissementsSiretAdresseGet200Response {\n");
        ...
        {
            return this.Equals(input as V3InseeSireneEtablissementsSiretAdresseGet200Response);
        }

        /// <summary>
        /// Returns true if V3InseeSireneEtablissementsSiretAdresseGet200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of V3InseeSireneEtablissementsSiretAdresseGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3InseeSireneEtablissementsSiretAdresseGet200Response input)
        {
            if (input == null)
            {
                return false;
