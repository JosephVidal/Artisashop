...
namespace EntreprisesApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Greffe")]
    public partial class Greffe : IEquatable<Greffe>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Greffe" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="Greffe" /> class.
        /// </summary>
        /// <param name="valeur">Nom du greffe en charge de l&#39;entreprise. (required).</param>
        /// <param name="code">Code du greffe en charge de l&#39;entreprise. (required).</param>
        public Greffe(string valeur = default(string), string code = default(string))
        {
            // to ensure "valeur" is required (not null)
            if (valeur == null)
            {
                throw new ArgumentNullException("valeur is a required property for Greffe and cannot be null");
            }
            this.Valeur = valeur;
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for Greffe and cannot be null");
            }
            this.Code = code;
        }

        /// <summary>
        /// Nom du greffe en charge de l&#39;entreprise.
        /// </summary>
        /// <value>Nom du greffe en charge de l&#39;entreprise.</value>
        [DataMember(Name = "valeur", IsRequired = true, EmitDefaultValue = true)]
        public string Valeur { get; set; }

        /// <summary>
        /// Code du greffe en charge de l&#39;entreprise.
        /// </summary>
        /// <value>Code du greffe en charge de l&#39;entreprise.</value>
        ...
        {
            return this.Equals(input as Greffe);
        }

        /// <summary>
        /// Returns true if Greffe instances are equal
        /// </summary>
        /// <param name="input">Instance of Greffe to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Greffe input)
        {
            if (input == null)
            {
                return false;
