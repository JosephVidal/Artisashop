...
{
    /// <summary>
    /// V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInner
    /// </summary>
    [DataContract(Name = "_v3_inpi_unites_legales__siren__marques_get_200_response_data_inner")]
    public partial class V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInner : IEquatable<V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInner" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        public V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInner(V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInnerData data = default(V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInnerData), V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInnerLinks links = default(V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInnerLinks))
        {
            this.Data = data;
            this.Links = links;
        }
        ...
        public V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInnerData Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name = "links", EmitDefaultValue = false)]
        public V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInnerLinks Links { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInner {\n");
        ...
        {
            return this.Equals(input as V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInner);
        }

        /// <summary>
        /// Returns true if V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInner input)
        {
            if (input == null)
            {
                return false;
