...
{
    /// <summary>
    /// V3AdemeEtablissementsSiretCertificationRgeGet200Response
    /// </summary>
    [DataContract(Name = "_v3_ademe_etablissements__siret__certification_rge_get_200_response")]
    public partial class V3AdemeEtablissementsSiretCertificationRgeGet200Response : IEquatable<V3AdemeEtablissementsSiretCertificationRgeGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3AdemeEtablissementsSiretCertificationRgeGet200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3AdemeEtablissementsSiretCertificationRgeGet200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3AdemeEtablissementsSiretCertificationRgeGet200Response" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public V3AdemeEtablissementsSiretCertificationRgeGet200Response(List<V3AdemeEtablissementsSiretCertificationRgeGet200ResponseDataInner> data = default(List<V3AdemeEtablissementsSiretCertificationRgeGet200ResponseDataInner>))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for V3AdemeEtablissementsSiretCertificationRgeGet200Response and cannot be null");
            }
            this.Data = data;
        }
        ...
        public List<V3AdemeEtablissementsSiretCertificationRgeGet200ResponseDataInner> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3AdemeEtablissementsSiretCertificationRgeGet200Response {\n");
        ...
        {
            return this.Equals(input as V3AdemeEtablissementsSiretCertificationRgeGet200Response);
        }

        /// <summary>
        /// Returns true if V3AdemeEtablissementsSiretCertificationRgeGet200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of V3AdemeEtablissementsSiretCertificationRgeGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3AdemeEtablissementsSiretCertificationRgeGet200Response input)
        {
            if (input == null)
            {
                return false;
