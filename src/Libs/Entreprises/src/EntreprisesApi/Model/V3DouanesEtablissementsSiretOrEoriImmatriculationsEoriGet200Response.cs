...
{
    /// <summary>
    /// V3DouanesEtablissementsSiretOrEoriImmatriculationsEoriGet200Response
    /// </summary>
    [DataContract(Name = "_v3_douanes_etablissements__siret_or_eori__immatriculations_eori_get_200_response")]
    public partial class V3DouanesEtablissementsSiretOrEoriImmatriculationsEoriGet200Response : IEquatable<V3DouanesEtablissementsSiretOrEoriImmatriculationsEoriGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3DouanesEtablissementsSiretOrEoriImmatriculationsEoriGet200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3DouanesEtablissementsSiretOrEoriImmatriculationsEoriGet200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3DouanesEtablissementsSiretOrEoriImmatriculationsEoriGet200Response" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public V3DouanesEtablissementsSiretOrEoriImmatriculationsEoriGet200Response(V3DouanesEtablissementsSiretOrEoriImmatriculationsEoriGet200ResponseData data = default(V3DouanesEtablissementsSiretOrEoriImmatriculationsEoriGet200ResponseData))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for V3DouanesEtablissementsSiretOrEoriImmatriculationsEoriGet200Response and cannot be null");
            }
            this.Data = data;
        }
        ...
        public V3DouanesEtablissementsSiretOrEoriImmatriculationsEoriGet200ResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3DouanesEtablissementsSiretOrEoriImmatriculationsEoriGet200Response {\n");
        ...
        {
            return this.Equals(input as V3DouanesEtablissementsSiretOrEoriImmatriculationsEoriGet200Response);
        }

        /// <summary>
        /// Returns true if V3DouanesEtablissementsSiretOrEoriImmatriculationsEoriGet200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of V3DouanesEtablissementsSiretOrEoriImmatriculationsEoriGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3DouanesEtablissementsSiretOrEoriImmatriculationsEoriGet200Response input)
        {
            if (input == null)
            {
                return false;
