...
{
    /// <summary>
    /// UnitLGaleDeLTablissement
    /// </summary>
    [DataContract(Name = "Unit__l_gale_de_l__tablissement")]
    public partial class UnitLGaleDeLTablissement : IEquatable<UnitLGaleDeLTablissement>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UnitLGaleDeLTablissement" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UnitLGaleDeLTablissement() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UnitLGaleDeLTablissement" /> class.
        /// </summary>
        ...
        public UnitLGaleDeLTablissement(string siretSiegeSocial = default(string), TypeEnum type = default(TypeEnum), AttributsDeLaPersonneMorale personneMoraleAttributs = default(AttributsDeLaPersonneMorale), AttributsDeLaPersonnePhysique personnePhysiqueAttributs = default(AttributsDeLaPersonnePhysique), CategorieEntrepriseEnum categorieEntreprise = default(CategorieEntrepriseEnum), bool diffusableCommercialement = default(bool), AttributsDeLaFormeJuridique formeJuridique = default(AttributsDeLaFormeJuridique), AttributsDeLActivitPrincipale1 activitePrincipale = default(AttributsDeLActivitPrincipale1), TrancheDEffectifSalariDeLUnitLGale trancheEffectifSalarie = default(TrancheDEffectifSalariDeLUnitLGale), EtatAdministratifEnum etatAdministratif = default(EtatAdministratifEnum), int dateCreation = default(int))
        {
            ...
            {
                throw new ArgumentNullException("personneMoraleAttributs is a required property for UnitLGaleDeLTablissement and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("personnePhysiqueAttributs is a required property for UnitLGaleDeLTablissement and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("formeJuridique is a required property for UnitLGaleDeLTablissement and cannot be null");
            }
            this.FormeJuridique = formeJuridique;
            // to ensure "activitePrincipale" is required (not null)
            if (activitePrincipale == null)
            {
                throw new ArgumentNullException("activitePrincipale is a required property for UnitLGaleDeLTablissement and cannot be null");
            }
            this.ActivitePrincipale = activitePrincipale;
            // to ensure "trancheEffectifSalarie" is required (not null)
            if (trancheEffectifSalarie == null)
            {
                throw new ArgumentNullException("trancheEffectifSalarie is a required property for UnitLGaleDeLTablissement and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UnitLGaleDeLTablissement {\n");
        ...
        {
            return this.Equals(input as UnitLGaleDeLTablissement);
        }

        /// <summary>
        /// Returns true if UnitLGaleDeLTablissement instances are equal
        /// </summary>
        /// <param name="input">Instance of UnitLGaleDeLTablissement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnitLGaleDeLTablissement input)
        {
            if (input == null)
            {
                return false;
