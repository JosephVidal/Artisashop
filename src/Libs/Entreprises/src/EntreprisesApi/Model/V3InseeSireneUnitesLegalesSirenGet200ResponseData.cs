...
{
    /// <summary>
    /// V3InseeSireneUnitesLegalesSirenGet200ResponseData
    /// </summary>
    [DataContract(Name = "_v3_insee_sirene_unites_legales__siren__get_200_response_data")]
    public partial class V3InseeSireneUnitesLegalesSirenGet200ResponseData : IEquatable<V3InseeSireneUnitesLegalesSirenGet200ResponseData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InseeSireneUnitesLegalesSirenGet200ResponseData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3InseeSireneUnitesLegalesSirenGet200ResponseData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InseeSireneUnitesLegalesSirenGet200ResponseData" /> class.
        /// </summary>
        ...
        /// <param name="diffusableCommercialement">Indique si l&#39;unité légale est :     - une unité légale diffusible : &#39;true&#39;   - une unité légale non-diffusible : &#39;false&#39;. Dans ce cas, les informations obtenues ne doivent en aucun cas être accessibles au grand public.     Plus d&#39;informations sur les conditions de diffusion : LIEN TODO (required).</param>
        ...
        public V3InseeSireneUnitesLegalesSirenGet200ResponseData(string siretSiegeSocial = default(string), TypeEnum type = default(TypeEnum), AttributsDeLaPersonneMorale personneMoraleAttributs = default(AttributsDeLaPersonneMorale), AttributsDeLaPersonnePhysique personnePhysiqueAttributs = default(AttributsDeLaPersonnePhysique), CategorieEntrepriseEnum categorieEntreprise = default(CategorieEntrepriseEnum), bool diffusableCommercialement = default(bool), AttributsDeLaFormeJuridique formeJuridique = default(AttributsDeLaFormeJuridique), AttributsDeLActivitPrincipale1 activitePrincipale = default(AttributsDeLActivitPrincipale1), TrancheDEffectifSalariDeLUnitLGale trancheEffectifSalarie = default(TrancheDEffectifSalariDeLUnitLGale), EtatAdministratifEnum etatAdministratif = default(EtatAdministratifEnum), int dateCreation = default(int), int? dateCessation = default(int?))
        {
            ...
            {
                throw new ArgumentNullException("personneMoraleAttributs is a required property for V3InseeSireneUnitesLegalesSirenGet200ResponseData and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("personnePhysiqueAttributs is a required property for V3InseeSireneUnitesLegalesSirenGet200ResponseData and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("formeJuridique is a required property for V3InseeSireneUnitesLegalesSirenGet200ResponseData and cannot be null");
            }
            this.FormeJuridique = formeJuridique;
            // to ensure "activitePrincipale" is required (not null)
            if (activitePrincipale == null)
            {
                throw new ArgumentNullException("activitePrincipale is a required property for V3InseeSireneUnitesLegalesSirenGet200ResponseData and cannot be null");
            }
            this.ActivitePrincipale = activitePrincipale;
            // to ensure "trancheEffectifSalarie" is required (not null)
            if (trancheEffectifSalarie == null)
            {
                throw new ArgumentNullException("trancheEffectifSalarie is a required property for V3InseeSireneUnitesLegalesSirenGet200ResponseData and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("dateCessation is a required property for V3InseeSireneUnitesLegalesSirenGet200ResponseData and cannot be null");
            }
        ...
        /// <summary>
        /// Indique si l&#39;unité légale est :     - une unité légale diffusible : &#39;true&#39;   - une unité légale non-diffusible : &#39;false&#39;. Dans ce cas, les informations obtenues ne doivent en aucun cas être accessibles au grand public.     Plus d&#39;informations sur les conditions de diffusion : LIEN TODO
        /// </summary>
        /// <value>Indique si l&#39;unité légale est :     - une unité légale diffusible : &#39;true&#39;   - une unité légale non-diffusible : &#39;false&#39;. Dans ce cas, les informations obtenues ne doivent en aucun cas être accessibles au grand public.     Plus d&#39;informations sur les conditions de diffusion : LIEN TODO</value>
        [DataMember(Name = "diffusable_commercialement", IsRequired = true, EmitDefaultValue = true)]
        public bool DiffusableCommercialement { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3InseeSireneUnitesLegalesSirenGet200ResponseData {\n");
        ...
        {
            return this.Equals(input as V3InseeSireneUnitesLegalesSirenGet200ResponseData);
        }

        /// <summary>
        /// Returns true if V3InseeSireneUnitesLegalesSirenGet200ResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of V3InseeSireneUnitesLegalesSirenGet200ResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3InseeSireneUnitesLegalesSirenGet200ResponseData input)
        {
            if (input == null)
            {
                return false;
