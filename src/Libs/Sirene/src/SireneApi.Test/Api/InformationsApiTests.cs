...
{
    /// <summary>
    ///  Class for testing InformationsApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class InformationsApiTests : IDisposable
    {
        private InformationsApi instance;

        public InformationsApiTests()
        {
            instance = new InformationsApi();
        }
        ...
        /// <summary>
        /// Test an instance of InformationsApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' InformationsApi
            //Assert.IsType<InformationsApi>(instance);
        }
        ...
        public void InformationsTest()
        {
            ...
            //var response = instance.Informations();
            //Assert.IsType<ReponseInformations>(response);
        }
    }
}
