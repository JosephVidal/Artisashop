...
namespace RechercheEntreprisesApi.Test.Api
{
    ...
    public class RechercheTextuelleApiTests : IDisposable
    {
        ...
        public void SearchGetTest()
        {
            ...
            //int? page = null;
            //int? perPage = null;
            //var response = instance.SearchGet(q, codePostal, departement, activitePrincipale, sectionActivitePrincipale, isEntrepreneurIndividuel, trancheEffectifSalarie, page, perPage);
