...
{
    /// <summary>
    /// NearPointGet200Response
    /// </summary>
    [DataContract(Name = "_near_point_get_200_response")]
    public partial class NearPointGet200Response : IEquatable<NearPointGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NearPointGet200Response" /> class.
        /// </summary>
        ...
        public NearPointGet200Response(List<NearPointGet200ResponseResultsInner> results = default(List<NearPointGet200ResponseResultsInner>), int totalResults = default(int), int page = 1, int perPage = 10, int totalPages = default(int))
        {
        ...
        public List<NearPointGet200ResponseResultsInner> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NearPointGet200Response {\n");
        ...
        {
            return this.Equals(input as NearPointGet200Response);
        }

        /// <summary>
        /// Returns true if NearPointGet200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of NearPointGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NearPointGet200Response input)
        {
            if (input == null)
            {
                return false;
