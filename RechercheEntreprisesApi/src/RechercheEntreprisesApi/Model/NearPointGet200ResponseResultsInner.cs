...
{
    /// <summary>
    /// NearPointGet200ResponseResultsInner
    /// </summary>
    [DataContract(Name = "_near_point_get_200_response_results_inner")]
    public partial class NearPointGet200ResponseResultsInner : IEquatable<NearPointGet200ResponseResultsInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NearPointGet200ResponseResultsInner" /> class.
        /// </summary>
        ...
        public NearPointGet200ResponseResultsInner(string siren = default(string), NearPointGet200ResponseResultsInnerSiege siege = default(NearPointGet200ResponseResultsInnerSiege), DateTime? dateCreation = default(DateTime?), string trancheEffectifSalarie = default(string), DateTime? dateMiseAJour = default(DateTime?), string categorieEntreprise = default(string), string etatAdministratif = default(string), string nomRaisonSociale = default(string), string natureJuridique = default(string), string activitePrincipale = default(string), string sectionActivitePrincipale = default(string), string economieSocialeSolidaire = default(string), string nomComplet = default(string), int nombreEtablissements = default(int), int nombreEtablissementsOuverts = default(int), bool isEntrepreneurIndividuel = default(bool))
        {
            this.Siren = siren;
            this.Siege = siege;
        ...
        public NearPointGet200ResponseResultsInnerSiege Siege { get; set; }
        ...
        /// </summary>
        [DataMember(Name = "date_mise_a_jour", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NearPointGet200ResponseResultsInner {\n");
        ...
        {
            return this.Equals(input as NearPointGet200ResponseResultsInner);
        }

        /// <summary>
        /// Returns true if NearPointGet200ResponseResultsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of NearPointGet200ResponseResultsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NearPointGet200ResponseResultsInner input)
        {
            if (input == null)
            {
                return false;
