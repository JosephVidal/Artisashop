...
namespace Artisashop.Tests.Backend
{
    ...
    public static class AccountControllerTest
    {
        ...
        [TestCase("john.artisan@epitech.eu", "John", "Artisan", "Password_1234", Account.UserType.CRAFTSMAN, null)]
        [TestCase("baby.partner@epitech.eu", "Baby", "Partner", "Password_1234", Account.UserType.PARTNER, null)]
        [TestCase("jane.consumer@epitech.eu", "Jane", "Consumer", "Password_1234", Account.UserType.CONSUMER, null)]
