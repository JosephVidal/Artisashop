...
namespace SireneApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ReponseEtablissementsNonDiffusibles")]
    public partial class ReponseEtablissementsNonDiffusibles : IEquatable<ReponseEtablissementsNonDiffusibles>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReponseEtablissementsNonDiffusibles" /> class.
        /// </summary>
        /// <param name="header">header.</param>
        /// <param name="etablissementsNonDiffusibles">etablissementsNonDiffusibles.</param>
        public ReponseEtablissementsNonDiffusibles(Header header = default(Header), List<EtablissementNonDiffusible> etablissementsNonDiffusibles = default(List<EtablissementNonDiffusible>))
        {
            this.Header = header;
            this.EtablissementsNonDiffusibles = etablissementsNonDiffusibles;
        }
        ...
        /// <summary>
        /// Gets or Sets EtablissementsNonDiffusibles
        /// </summary>
        [DataMember(Name = "etablissementsNonDiffusibles", EmitDefaultValue = false)]
        public List<EtablissementNonDiffusible> EtablissementsNonDiffusibles { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReponseEtablissementsNonDiffusibles {\n");
            sb.Append("  Header: ").Append(Header).Append("\n");
            sb.Append("  EtablissementsNonDiffusibles: ").Append(EtablissementsNonDiffusibles).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ReponseEtablissementsNonDiffusibles);
        }

        /// <summary>
        /// Returns true if ReponseEtablissementsNonDiffusibles instances are equal
        /// </summary>
        /// <param name="input">Instance of ReponseEtablissementsNonDiffusibles to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReponseEtablissementsNonDiffusibles input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.EtablissementsNonDiffusibles == input.EtablissementsNonDiffusibles ||
                    this.EtablissementsNonDiffusibles != null &&
                    input.EtablissementsNonDiffusibles != null &&
                    this.EtablissementsNonDiffusibles.SequenceEqual(input.EtablissementsNonDiffusibles)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EtablissementsNonDiffusibles != null)
                {
                    hashCode = (hashCode * 59) + this.EtablissementsNonDiffusibles.GetHashCode();
                }
                return hashCode;
            }
        }
