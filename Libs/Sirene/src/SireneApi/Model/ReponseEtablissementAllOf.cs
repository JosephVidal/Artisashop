...
namespace SireneApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ReponseEtablissement_allOf")]
    public partial class ReponseEtablissementAllOf : IEquatable<ReponseEtablissementAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReponseEtablissementAllOf" /> class.
        /// </summary>
        /// <param name="etablissement">etablissement.</param>
        public ReponseEtablissementAllOf(Etablissement etablissement = default(Etablissement))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReponseEtablissementAllOf {\n");
        ...
        {
            return this.Equals(input as ReponseEtablissementAllOf);
        }

        /// <summary>
        /// Returns true if ReponseEtablissementAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ReponseEtablissementAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReponseEtablissementAllOf input)
        {
            if (input == null)
            {
                return false;
