...
namespace SireneApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ReponseUniteLegale_allOf")]
    public partial class ReponseUniteLegaleAllOf : IEquatable<ReponseUniteLegaleAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReponseUniteLegaleAllOf" /> class.
        /// </summary>
        /// <param name="uniteLegale">uniteLegale.</param>
        public ReponseUniteLegaleAllOf(UniteLegale uniteLegale = default(UniteLegale))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReponseUniteLegaleAllOf {\n");
        ...
        {
            return this.Equals(input as ReponseUniteLegaleAllOf);
        }

        /// <summary>
        /// Returns true if ReponseUniteLegaleAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ReponseUniteLegaleAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReponseUniteLegaleAllOf input)
        {
            if (input == null)
            {
                return false;
