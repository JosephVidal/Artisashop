...
namespace SireneApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ReponseEtablissements")]
    public partial class ReponseEtablissements : IEquatable<ReponseEtablissements>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReponseEtablissements" /> class.
        /// </summary>
        /// <param name="header">header.</param>
        /// <param name="etablissements">etablissements.</param>
        /// <param name="facettes">facettes.</param>
        public ReponseEtablissements(Header header = default(Header), List<Etablissement> etablissements = default(List<Etablissement>), List<Facette> facettes = default(List<Facette>))
        {
            this.Header = header;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReponseEtablissements {\n");
        ...
        {
            return this.Equals(input as ReponseEtablissements);
        }

        /// <summary>
        /// Returns true if ReponseEtablissements instances are equal
        /// </summary>
        /// <param name="input">Instance of ReponseEtablissements to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReponseEtablissements input)
        {
            if (input == null)
            {
                return false;
