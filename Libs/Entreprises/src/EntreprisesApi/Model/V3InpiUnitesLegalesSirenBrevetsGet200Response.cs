...
{
    /// <summary>
    /// V3InpiUnitesLegalesSirenBrevetsGet200Response
    /// </summary>
    [DataContract(Name = "_v3_inpi_unites_legales__siren__brevets_get_200_response")]
    public partial class V3InpiUnitesLegalesSirenBrevetsGet200Response : IEquatable<V3InpiUnitesLegalesSirenBrevetsGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InpiUnitesLegalesSirenBrevetsGet200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3InpiUnitesLegalesSirenBrevetsGet200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InpiUnitesLegalesSirenBrevetsGet200Response" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public V3InpiUnitesLegalesSirenBrevetsGet200Response(List<V3InpiUnitesLegalesSirenBrevetsGet200ResponseDataInner> data = default(List<V3InpiUnitesLegalesSirenBrevetsGet200ResponseDataInner>))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for V3InpiUnitesLegalesSirenBrevetsGet200Response and cannot be null");
            }
            this.Data = data;
        }
        ...
        public List<V3InpiUnitesLegalesSirenBrevetsGet200ResponseDataInner> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3InpiUnitesLegalesSirenBrevetsGet200Response {\n");
        ...
        {
            return this.Equals(input as V3InpiUnitesLegalesSirenBrevetsGet200Response);
        }

        /// <summary>
        /// Returns true if V3InpiUnitesLegalesSirenBrevetsGet200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of V3InpiUnitesLegalesSirenBrevetsGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3InpiUnitesLegalesSirenBrevetsGet200Response input)
        {
            if (input == null)
            {
                return false;
