...
{
    /// <summary>
    /// V3InpiUnitesLegalesSirenMarquesGet200Response
    /// </summary>
    [DataContract(Name = "_v3_inpi_unites_legales__siren__marques_get_200_response")]
    public partial class V3InpiUnitesLegalesSirenMarquesGet200Response : IEquatable<V3InpiUnitesLegalesSirenMarquesGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InpiUnitesLegalesSirenMarquesGet200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3InpiUnitesLegalesSirenMarquesGet200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InpiUnitesLegalesSirenMarquesGet200Response" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public V3InpiUnitesLegalesSirenMarquesGet200Response(List<V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInner> data = default(List<V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInner>))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for V3InpiUnitesLegalesSirenMarquesGet200Response and cannot be null");
            }
            this.Data = data;
        }
        ...
        public List<V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInner> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3InpiUnitesLegalesSirenMarquesGet200Response {\n");
        ...
        {
            return this.Equals(input as V3InpiUnitesLegalesSirenMarquesGet200Response);
        }

        /// <summary>
        /// Returns true if V3InpiUnitesLegalesSirenMarquesGet200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of V3InpiUnitesLegalesSirenMarquesGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3InpiUnitesLegalesSirenMarquesGet200Response input)
        {
            if (input == null)
            {
                return false;
