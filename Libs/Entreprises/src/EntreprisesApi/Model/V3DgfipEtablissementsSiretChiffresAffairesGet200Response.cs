...
{
    /// <summary>
    /// V3DgfipEtablissementsSiretChiffresAffairesGet200Response
    /// </summary>
    [DataContract(Name = "_v3_dgfip_etablissements__siret__chiffres_affaires_get_200_response")]
    public partial class V3DgfipEtablissementsSiretChiffresAffairesGet200Response : IEquatable<V3DgfipEtablissementsSiretChiffresAffairesGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3DgfipEtablissementsSiretChiffresAffairesGet200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3DgfipEtablissementsSiretChiffresAffairesGet200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3DgfipEtablissementsSiretChiffresAffairesGet200Response" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public V3DgfipEtablissementsSiretChiffresAffairesGet200Response(List<V3DgfipEtablissementsSiretChiffresAffairesGet200ResponseDataInner> data = default(List<V3DgfipEtablissementsSiretChiffresAffairesGet200ResponseDataInner>))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for V3DgfipEtablissementsSiretChiffresAffairesGet200Response and cannot be null");
            }
            this.Data = data;
        }
        ...
        public List<V3DgfipEtablissementsSiretChiffresAffairesGet200ResponseDataInner> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3DgfipEtablissementsSiretChiffresAffairesGet200Response {\n");
        ...
        {
            return this.Equals(input as V3DgfipEtablissementsSiretChiffresAffairesGet200Response);
        }

        /// <summary>
        /// Returns true if V3DgfipEtablissementsSiretChiffresAffairesGet200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of V3DgfipEtablissementsSiretChiffresAffairesGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3DgfipEtablissementsSiretChiffresAffairesGet200Response input)
        {
            if (input == null)
            {
                return false;
