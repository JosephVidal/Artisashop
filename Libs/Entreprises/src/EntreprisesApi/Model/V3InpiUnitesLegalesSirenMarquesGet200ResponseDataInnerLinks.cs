...
{
    /// <summary>
    /// V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInnerLinks
    /// </summary>
    [DataContract(Name = "_v3_inpi_unites_legales__siren__marques_get_200_response_data_inner_links")]
    public partial class V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInnerLinks : IEquatable<V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInnerLinks>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInnerLinks" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInnerLinks() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInnerLinks" /> class.
        /// </summary>
        /// <param name="notice">Lien vers la notice concernant ce dépôt de marque, au format XML. (required).</param>
        public V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInnerLinks(string notice = default(string))
        {
            // to ensure "notice" is required (not null)
            if (notice == null)
            {
                throw new ArgumentNullException("notice is a required property for V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInnerLinks and cannot be null");
            }
            this.Notice = notice;
        }

        /// <summary>
        /// Lien vers la notice concernant ce dépôt de marque, au format XML.
        /// </summary>
        /// <value>Lien vers la notice concernant ce dépôt de marque, au format XML.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInnerLinks {\n");
        ...
        {
            return this.Equals(input as V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInnerLinks);
        }

        /// <summary>
        /// Returns true if V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInnerLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInnerLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3InpiUnitesLegalesSirenMarquesGet200ResponseDataInnerLinks input)
        {
            if (input == null)
            {
                return false;
