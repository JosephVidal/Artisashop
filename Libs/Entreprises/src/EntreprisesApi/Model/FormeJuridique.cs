...
namespace EntreprisesApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Forme_juridique")]
    public partial class FormeJuridique : IEquatable<FormeJuridique>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FormeJuridique" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="FormeJuridique" /> class.
        /// </summary>
        /// <param name="valeur">valeur (required).</param>
        /// <param name="code">Code représentant la forme juridique de l&#39;entreprise. Attention, la nomenclature est différente de celle de l&#39;INSEE. (required).</param>
        public FormeJuridique(string valeur = default(string), string code = default(string))
        {
            // to ensure "valeur" is required (not null)
            if (valeur == null)
            {
                throw new ArgumentNullException("valeur is a required property for FormeJuridique and cannot be null");
            }
            this.Valeur = valeur;
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for FormeJuridique and cannot be null");
            }
            this.Code = code;
        }
        ...
        /// Gets or Sets Valeur
        /// </summary>
        [DataMember(Name = "valeur", IsRequired = true, EmitDefaultValue = true)]
        public string Valeur { get; set; }

        /// <summary>
        /// Code représentant la forme juridique de l&#39;entreprise. Attention, la nomenclature est différente de celle de l&#39;INSEE.
        /// </summary>
        /// <value>Code représentant la forme juridique de l&#39;entreprise. Attention, la nomenclature est différente de celle de l&#39;INSEE.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FormeJuridique {\n");
        ...
        {
            return this.Equals(input as FormeJuridique);
        }

        /// <summary>
        /// Returns true if FormeJuridique instances are equal
        /// </summary>
        /// <param name="input">Instance of FormeJuridique to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FormeJuridique input)
        {
            if (input == null)
            {
                return false;
