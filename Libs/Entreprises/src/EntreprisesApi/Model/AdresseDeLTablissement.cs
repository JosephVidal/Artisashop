...
{
    /// <summary>
    /// AdresseDeLTablissement
    /// </summary>
    [DataContract(Name = "Adresse_de_l__tablissement")]
    public partial class AdresseDeLTablissement : IEquatable<AdresseDeLTablissement>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AdresseDeLTablissement" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AdresseDeLTablissement() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AdresseDeLTablissement" /> class.
        /// </summary>
        ...
        public AdresseDeLTablissement(string numeroVoie = default(string), IndiceRepetitionVoieEnum indiceRepetitionVoie = default(IndiceRepetitionVoieEnum), TypeVoieEnum typeVoie = default(TypeVoieEnum), string libelleVoie = default(string), string complementAdresse = default(string), string codeCommune = default(string), string codePostal = default(string), string distributionSpeciale = default(string), string codeCedex = default(string), string libelleCedex = default(string), string libelleCommune = default(string), string libelleCommuneEtranger = default(string), string codePaysEtranger = default(string), string libellePaysEtranger = default(string), LMentsConstitutifsDeLAdressePostalePourSonAcheminement acheminementPostal = default(LMentsConstitutifsDeLAdressePostalePourSonAcheminement))
        {
            ...
            if (libelleVoie == null)
            {
                throw new ArgumentNullException("libelleVoie is a required property for AdresseDeLTablissement and cannot be null");
            }
            this.LibelleVoie = libelleVoie;
            // to ensure "complementAdresse" is required (not null)
            if (complementAdresse == null)
            {
                throw new ArgumentNullException("complementAdresse is a required property for AdresseDeLTablissement and cannot be null");
            }
            this.ComplementAdresse = complementAdresse;
            // to ensure "codeCommune" is required (not null)
            if (codeCommune == null)
            {
                throw new ArgumentNullException("codeCommune is a required property for AdresseDeLTablissement and cannot be null");
            }
            this.CodeCommune = codeCommune;
            // to ensure "codePostal" is required (not null)
            if (codePostal == null)
            {
                throw new ArgumentNullException("codePostal is a required property for AdresseDeLTablissement and cannot be null");
            }
            this.CodePostal = codePostal;
            // to ensure "distributionSpeciale" is required (not null)
            if (distributionSpeciale == null)
            {
                throw new ArgumentNullException("distributionSpeciale is a required property for AdresseDeLTablissement and cannot be null");
            }
            this.DistributionSpeciale = distributionSpeciale;
            // to ensure "codeCedex" is required (not null)
            if (codeCedex == null)
            {
                throw new ArgumentNullException("codeCedex is a required property for AdresseDeLTablissement and cannot be null");
            }
            this.CodeCedex = codeCedex;
            // to ensure "libelleCedex" is required (not null)
            if (libelleCedex == null)
            {
                throw new ArgumentNullException("libelleCedex is a required property for AdresseDeLTablissement and cannot be null");
            }
            this.LibelleCedex = libelleCedex;
            // to ensure "libelleCommune" is required (not null)
            if (libelleCommune == null)
            {
                throw new ArgumentNullException("libelleCommune is a required property for AdresseDeLTablissement and cannot be null");
            }
            this.LibelleCommune = libelleCommune;
            // to ensure "libelleCommuneEtranger" is required (not null)
            if (libelleCommuneEtranger == null)
            {
                throw new ArgumentNullException("libelleCommuneEtranger is a required property for AdresseDeLTablissement and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("codePaysEtranger is a required property for AdresseDeLTablissement and cannot be null");
            }
            this.CodePaysEtranger = codePaysEtranger;
            // to ensure "libellePaysEtranger" is required (not null)
            if (libellePaysEtranger == null)
            {
                throw new ArgumentNullException("libellePaysEtranger is a required property for AdresseDeLTablissement and cannot be null");
            }
            this.LibellePaysEtranger = libellePaysEtranger;
            // to ensure "acheminementPostal" is required (not null)
            if (acheminementPostal == null)
            {
                throw new ArgumentNullException("acheminementPostal is a required property for AdresseDeLTablissement and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdresseDeLTablissement {\n");
        ...
        {
            return this.Equals(input as AdresseDeLTablissement);
        }

        /// <summary>
        /// Returns true if AdresseDeLTablissement instances are equal
        /// </summary>
        /// <param name="input">Instance of AdresseDeLTablissement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdresseDeLTablissement input)
        {
            if (input == null)
            {
                return false;
