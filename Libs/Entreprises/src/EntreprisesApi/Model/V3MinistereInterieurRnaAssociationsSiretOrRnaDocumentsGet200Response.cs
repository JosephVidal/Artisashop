...
{
    /// <summary>
    /// V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200Response
    /// </summary>
    [DataContract(Name = "_v3_ministere_interieur_rna_associations__siret_or_rna__documents_get_200_response")]
    public partial class V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200Response : IEquatable<V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200Response" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="meta">meta (required).</param>
        public V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200Response(List<V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200ResponseDataInner> data = default(List<V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200ResponseDataInner>), V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200ResponseMeta meta = default(V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200ResponseMeta))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200Response and cannot be null");
            }
            this.Data = data;
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new ArgumentNullException("meta is a required property for V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200Response and cannot be null");
            }
            this.Meta = meta;
        }
        ...
        public List<V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200ResponseDataInner> Data { get; set; }

        /// <summary>
        /// Gets or Sets Meta
        /// </summary>
        [DataMember(Name = "meta", IsRequired = true, EmitDefaultValue = true)]
        public V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200ResponseMeta Meta { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200Response {\n");
        ...
        {
            return this.Equals(input as V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200Response);
        }

        /// <summary>
        /// Returns true if V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200Response input)
        {
            if (input == null)
            {
                return false;
