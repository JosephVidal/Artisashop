...
{
    /// <summary>
    /// V3MinistereInterieurRnaAssociationsSiretOrRnaGet200Response
    /// </summary>
    [DataContract(Name = "_v3_ministere_interieur_rna_associations__siret_or_rna__get_200_response")]
    public partial class V3MinistereInterieurRnaAssociationsSiretOrRnaGet200Response : IEquatable<V3MinistereInterieurRnaAssociationsSiretOrRnaGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3MinistereInterieurRnaAssociationsSiretOrRnaGet200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3MinistereInterieurRnaAssociationsSiretOrRnaGet200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3MinistereInterieurRnaAssociationsSiretOrRnaGet200Response" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public V3MinistereInterieurRnaAssociationsSiretOrRnaGet200Response(V3MinistereInterieurRnaAssociationsSiretOrRnaGet200ResponseData data = default(V3MinistereInterieurRnaAssociationsSiretOrRnaGet200ResponseData))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for V3MinistereInterieurRnaAssociationsSiretOrRnaGet200Response and cannot be null");
            }
            this.Data = data;
        }
        ...
        public V3MinistereInterieurRnaAssociationsSiretOrRnaGet200ResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3MinistereInterieurRnaAssociationsSiretOrRnaGet200Response {\n");
        ...
        {
            return this.Equals(input as V3MinistereInterieurRnaAssociationsSiretOrRnaGet200Response);
        }

        /// <summary>
        /// Returns true if V3MinistereInterieurRnaAssociationsSiretOrRnaGet200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of V3MinistereInterieurRnaAssociationsSiretOrRnaGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3MinistereInterieurRnaAssociationsSiretOrRnaGet200Response input)
        {
            if (input == null)
            {
                return false;
