...
{
    /// <summary>
    /// EnsembleDesObservationsDuGreffierInner
    /// </summary>
    [DataContract(Name = "Ensemble_des_observations_du_greffier_inner")]
    public partial class EnsembleDesObservationsDuGreffierInner : IEquatable<EnsembleDesObservationsDuGreffierInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnsembleDesObservationsDuGreffierInner" /> class.
        /// </summary>
        /// <param name="numero">numero.</param>
        /// <param name="libelle">libelle.</param>
        /// <param name="date">date.</param>
        public EnsembleDesObservationsDuGreffierInner(string numero = default(string), string libelle = default(string), string date = default(string))
        {
            this.Numero = numero;
        ...
        /// </summary>
        [DataMember(Name = "libelle", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnsembleDesObservationsDuGreffierInner {\n");
        ...
        {
            return this.Equals(input as EnsembleDesObservationsDuGreffierInner);
        }

        /// <summary>
        /// Returns true if EnsembleDesObservationsDuGreffierInner instances are equal
        /// </summary>
        /// <param name="input">Instance of EnsembleDesObservationsDuGreffierInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnsembleDesObservationsDuGreffierInner input)
        {
            if (input == null)
            {
                return false;
