...
{
    /// <summary>
    /// V3MsaEtablissementsSiretConformiteCotisationsGet200Response
    /// </summary>
    [DataContract(Name = "_v3_msa_etablissements__siret__conformite_cotisations_get_200_response")]
    public partial class V3MsaEtablissementsSiretConformiteCotisationsGet200Response : IEquatable<V3MsaEtablissementsSiretConformiteCotisationsGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3MsaEtablissementsSiretConformiteCotisationsGet200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3MsaEtablissementsSiretConformiteCotisationsGet200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3MsaEtablissementsSiretConformiteCotisationsGet200Response" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public V3MsaEtablissementsSiretConformiteCotisationsGet200Response(V3MsaEtablissementsSiretConformiteCotisationsGet200ResponseData data = default(V3MsaEtablissementsSiretConformiteCotisationsGet200ResponseData))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for V3MsaEtablissementsSiretConformiteCotisationsGet200Response and cannot be null");
            }
            this.Data = data;
        }
        ...
        public V3MsaEtablissementsSiretConformiteCotisationsGet200ResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3MsaEtablissementsSiretConformiteCotisationsGet200Response {\n");
        ...
        {
            return this.Equals(input as V3MsaEtablissementsSiretConformiteCotisationsGet200Response);
        }

        /// <summary>
        /// Returns true if V3MsaEtablissementsSiretConformiteCotisationsGet200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of V3MsaEtablissementsSiretConformiteCotisationsGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3MsaEtablissementsSiretConformiteCotisationsGet200Response input)
        {
            if (input == null)
            {
                return false;
