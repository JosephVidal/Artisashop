...
{
    /// <summary>
    /// V3EuropeanCommissionUnitesLegalesSirenNumeroTvaGet200Response
    /// </summary>
    [DataContract(Name = "_v3_european_commission_unites_legales__siren__numero_tva_get_200_response")]
    public partial class V3EuropeanCommissionUnitesLegalesSirenNumeroTvaGet200Response : IEquatable<V3EuropeanCommissionUnitesLegalesSirenNumeroTvaGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3EuropeanCommissionUnitesLegalesSirenNumeroTvaGet200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3EuropeanCommissionUnitesLegalesSirenNumeroTvaGet200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3EuropeanCommissionUnitesLegalesSirenNumeroTvaGet200Response" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public V3EuropeanCommissionUnitesLegalesSirenNumeroTvaGet200Response(V3EuropeanCommissionUnitesLegalesSirenNumeroTvaGet200ResponseData data = default(V3EuropeanCommissionUnitesLegalesSirenNumeroTvaGet200ResponseData))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for V3EuropeanCommissionUnitesLegalesSirenNumeroTvaGet200Response and cannot be null");
            }
            this.Data = data;
        }
        ...
        public V3EuropeanCommissionUnitesLegalesSirenNumeroTvaGet200ResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3EuropeanCommissionUnitesLegalesSirenNumeroTvaGet200Response {\n");
        ...
        {
            return this.Equals(input as V3EuropeanCommissionUnitesLegalesSirenNumeroTvaGet200Response);
        }

        /// <summary>
        /// Returns true if V3EuropeanCommissionUnitesLegalesSirenNumeroTvaGet200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of V3EuropeanCommissionUnitesLegalesSirenNumeroTvaGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3EuropeanCommissionUnitesLegalesSirenNumeroTvaGet200Response input)
        {
            if (input == null)
            {
                return false;
