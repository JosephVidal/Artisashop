...
namespace EntreprisesApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Pays_de_naissance")]
    public partial class PaysDeNaissance : IEquatable<PaysDeNaissance>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaysDeNaissance" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="PaysDeNaissance" /> class.
        /// </summary>
        /// <param name="valeur">Nom du pays de naissance de la personne physique (required).</param>
        /// <param name="code">Code du pays de naissance de la personne physique (required).</param>
        public PaysDeNaissance(string valeur = default(string), string code = default(string))
        {
            // to ensure "valeur" is required (not null)
            if (valeur == null)
            {
                throw new ArgumentNullException("valeur is a required property for PaysDeNaissance and cannot be null");
            }
            this.Valeur = valeur;
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for PaysDeNaissance and cannot be null");
            }
            this.Code = code;
        }

        /// <summary>
        /// Nom du pays de naissance de la personne physique
        /// </summary>
        /// <value>Nom du pays de naissance de la personne physique</value>
        [DataMember(Name = "valeur", IsRequired = true, EmitDefaultValue = true)]
        public string Valeur { get; set; }

        /// <summary>
        /// Code du pays de naissance de la personne physique
        /// </summary>
        /// <value>Code du pays de naissance de la personne physique</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaysDeNaissance {\n");
        ...
        {
            return this.Equals(input as PaysDeNaissance);
        }

        /// <summary>
        /// Returns true if PaysDeNaissance instances are equal
        /// </summary>
        /// <param name="input">Instance of PaysDeNaissance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaysDeNaissance input)
        {
            if (input == null)
            {
                return false;
