...
{
    /// <summary>
    /// V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200ResponseData
    /// </summary>
    [DataContract(Name = "_v3_fntp_unites_legales__siren__carte_professionnelle_travaux_publics_get_200_response_data")]
    public partial class V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200ResponseData : IEquatable<V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200ResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200ResponseData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200ResponseData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200ResponseData" /> class.
        /// </summary>
        ...
        public V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200ResponseData(string documentUrl = default(string), int expiresIn = default(int))
        {
            // to ensure "documentUrl" is required (not null)
            if (documentUrl == null)
            {
                throw new ArgumentNullException("documentUrl is a required property for V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200ResponseData and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200ResponseData {\n");
        ...
        {
            return this.Equals(input as V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200ResponseData);
        }

        /// <summary>
        /// Returns true if V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200ResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200ResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200ResponseData input)
        {
            if (input == null)
            {
                return false;
