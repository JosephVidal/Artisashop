...
{
    /// <summary>
    /// V3ProbtpEtablissementsSiretConformiteCotisationsRetraiteGet200Response
    /// </summary>
    [DataContract(Name = "_v3_probtp_etablissements__siret__conformite_cotisations_retraite_get_200_response")]
    public partial class V3ProbtpEtablissementsSiretConformiteCotisationsRetraiteGet200Response : IEquatable<V3ProbtpEtablissementsSiretConformiteCotisationsRetraiteGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3ProbtpEtablissementsSiretConformiteCotisationsRetraiteGet200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3ProbtpEtablissementsSiretConformiteCotisationsRetraiteGet200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3ProbtpEtablissementsSiretConformiteCotisationsRetraiteGet200Response" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public V3ProbtpEtablissementsSiretConformiteCotisationsRetraiteGet200Response(V3ProbtpEtablissementsSiretConformiteCotisationsRetraiteGet200ResponseData data = default(V3ProbtpEtablissementsSiretConformiteCotisationsRetraiteGet200ResponseData))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for V3ProbtpEtablissementsSiretConformiteCotisationsRetraiteGet200Response and cannot be null");
            }
            this.Data = data;
        }
        ...
        public V3ProbtpEtablissementsSiretConformiteCotisationsRetraiteGet200ResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3ProbtpEtablissementsSiretConformiteCotisationsRetraiteGet200Response {\n");
        ...
        {
            return this.Equals(input as V3ProbtpEtablissementsSiretConformiteCotisationsRetraiteGet200Response);
        }

        /// <summary>
        /// Returns true if V3ProbtpEtablissementsSiretConformiteCotisationsRetraiteGet200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of V3ProbtpEtablissementsSiretConformiteCotisationsRetraiteGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3ProbtpEtablissementsSiretConformiteCotisationsRetraiteGet200Response input)
        {
            if (input == null)
            {
                return false;
