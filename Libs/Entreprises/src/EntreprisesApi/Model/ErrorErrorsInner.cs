...
namespace EntreprisesApi.Model
{
    ...
    /// ErrorErrorsInner
    /// </summary>
    [DataContract(Name = "Error_errors_inner")]
    public partial class ErrorErrorsInner : IEquatable<ErrorErrorsInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorErrorsInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ErrorErrorsInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorErrorsInner" /> class.
        /// </summary>
        ...
        public ErrorErrorsInner(string title = default(string), string detail = default(string), string code = default(string))
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for ErrorErrorsInner and cannot be null");
            }
            this.Title = title;
            // to ensure "detail" is required (not null)
            if (detail == null)
            {
                throw new ArgumentNullException("detail is a required property for ErrorErrorsInner and cannot be null");
            }
            this.Detail = detail;
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for ErrorErrorsInner and cannot be null");
            }
            this.Code = code;
        }
        ...
        {
            return this.Equals(input as ErrorErrorsInner);
        }

        /// <summary>
        /// Returns true if ErrorErrorsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ErrorErrorsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ErrorErrorsInner input)
        {
            if (input == null)
            {
                return false;
