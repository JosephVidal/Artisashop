...
{
    /// <summary>
    /// V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200Response
    /// </summary>
    [DataContract(Name = "_v3_infogreffe_rcs_unites_legales__siren__mandataires_sociaux_get_200_response")]
    public partial class V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200Response : IEquatable<V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200Response" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="meta">meta (required).</param>
        public V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200Response(List<V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200ResponseDataInner> data = default(List<V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200ResponseDataInner>), V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200ResponseMeta meta = default(V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200ResponseMeta))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200Response and cannot be null");
            }
            this.Data = data;
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new ArgumentNullException("meta is a required property for V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200Response and cannot be null");
            }
            this.Meta = meta;
        }
        ...
        public List<V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200ResponseDataInner> Data { get; set; }

        /// <summary>
        /// Gets or Sets Meta
        /// </summary>
        [DataMember(Name = "meta", IsRequired = true, EmitDefaultValue = true)]
        public V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200ResponseMeta Meta { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200Response {\n");
        ...
        {
            return this.Equals(input as V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200Response);
        }

        /// <summary>
        /// Returns true if V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200Response input)
        {
            if (input == null)
            {
                return false;
