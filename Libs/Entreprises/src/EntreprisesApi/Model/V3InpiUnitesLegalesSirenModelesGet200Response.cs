...
{
    /// <summary>
    /// V3InpiUnitesLegalesSirenModelesGet200Response
    /// </summary>
    [DataContract(Name = "_v3_inpi_unites_legales__siren__modeles_get_200_response")]
    public partial class V3InpiUnitesLegalesSirenModelesGet200Response : IEquatable<V3InpiUnitesLegalesSirenModelesGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InpiUnitesLegalesSirenModelesGet200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3InpiUnitesLegalesSirenModelesGet200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InpiUnitesLegalesSirenModelesGet200Response" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public V3InpiUnitesLegalesSirenModelesGet200Response(List<V3InpiUnitesLegalesSirenModelesGet200ResponseDataInner> data = default(List<V3InpiUnitesLegalesSirenModelesGet200ResponseDataInner>))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for V3InpiUnitesLegalesSirenModelesGet200Response and cannot be null");
            }
            this.Data = data;
        }
        ...
        public List<V3InpiUnitesLegalesSirenModelesGet200ResponseDataInner> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3InpiUnitesLegalesSirenModelesGet200Response {\n");
        ...
        {
            return this.Equals(input as V3InpiUnitesLegalesSirenModelesGet200Response);
        }

        /// <summary>
        /// Returns true if V3InpiUnitesLegalesSirenModelesGet200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of V3InpiUnitesLegalesSirenModelesGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3InpiUnitesLegalesSirenModelesGet200Response input)
        {
            if (input == null)
            {
                return false;
