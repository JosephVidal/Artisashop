...
export class ProductApi extends runtime.BaseAPI {
    ...
    /**
     */
    async apiProductListGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Product>>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async apiProductListGet(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Product>> {
        const response = await this.apiProductListGetRaw(initOverrides);
        return await response.value();
    }
