...
export function BasketFromJSONTyped(json: any, ignoreDiscriminator: boolean): Basket {
    ...
    return {
        ...
        'deliveryOpt': !exists(json, 'deliveryOpt') ? undefined : DeliveryOptionFromJSON(json['deliveryOpt']),
        'currentState': !exists(json, 'currentState') ? undefined : StateFromJSON(json['currentState']),
