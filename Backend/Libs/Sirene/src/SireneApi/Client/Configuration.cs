...
namespace SireneApi.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://api.insee.fr/entreprises/sirene/V3";
        ...
        public Configuration(
            ...
            string basePath = "https://api.insee.fr/entreprises/sirene/V3") : this()
        {
        ...
        {
            string report = "C# SDK (SireneApi) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 3.9\n";
