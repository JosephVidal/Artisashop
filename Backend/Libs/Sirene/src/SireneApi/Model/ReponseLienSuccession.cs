...
namespace SireneApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ReponseLienSuccession")]
    public partial class ReponseLienSuccession : IEquatable<ReponseLienSuccession>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReponseLienSuccession" /> class.
        /// </summary>
        /// <param name="header">header.</param>
        /// <param name="liensSuccession">liensSuccession.</param>
        public ReponseLienSuccession(Header header = default(Header), List<LienSuccession> liensSuccession = default(List<LienSuccession>))
        {
            this.Header = header;
        ...
        /// <summary>
        /// Gets or Sets LiensSuccession
        /// </summary>
        [DataMember(Name = "liensSuccession", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReponseLienSuccession {\n");
            sb.Append("  Header: ").Append(Header).Append("\n");
            sb.Append("  LiensSuccession: ").Append(LiensSuccession).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ReponseLienSuccession);
        }

        /// <summary>
        /// Returns true if ReponseLienSuccession instances are equal
        /// </summary>
        /// <param name="input">Instance of ReponseLienSuccession to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReponseLienSuccession input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.LiensSuccession == input.LiensSuccession ||
                    this.LiensSuccession != null &&
                    input.LiensSuccession != null &&
                    this.LiensSuccession.SequenceEqual(input.LiensSuccession)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LiensSuccession != null)
                {
                    hashCode = (hashCode * 59) + this.LiensSuccession.GetHashCode();
                }
                return hashCode;
            }
        }
