...
namespace SireneApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ReponseRefusImmatriculationRCS")]
    public partial class ReponseRefusImmatriculationRCS : IEquatable<ReponseRefusImmatriculationRCS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReponseRefusImmatriculationRCS" /> class.
        /// </summary>
        /// <param name="header">header.</param>
        /// <param name="unitesLegalesRefuseesRcs">unitesLegalesRefuseesRcs.</param>
        public ReponseRefusImmatriculationRCS(Header header = default(Header), List<RefusImmatriculationRCS> unitesLegalesRefuseesRcs = default(List<RefusImmatriculationRCS>))
        {
            this.Header = header;
            this.UnitesLegalesRefuseesRcs = unitesLegalesRefuseesRcs;
        }
        ...
        /// <summary>
        /// Gets or Sets UnitesLegalesRefuseesRcs
        /// </summary>
        [DataMember(Name = "unitesLegalesRefuseesRcs", EmitDefaultValue = false)]
        public List<RefusImmatriculationRCS> UnitesLegalesRefuseesRcs { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReponseRefusImmatriculationRCS {\n");
            sb.Append("  Header: ").Append(Header).Append("\n");
            sb.Append("  UnitesLegalesRefuseesRcs: ").Append(UnitesLegalesRefuseesRcs).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ReponseRefusImmatriculationRCS);
        }

        /// <summary>
        /// Returns true if ReponseRefusImmatriculationRCS instances are equal
        /// </summary>
        /// <param name="input">Instance of ReponseRefusImmatriculationRCS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReponseRefusImmatriculationRCS input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.UnitesLegalesRefuseesRcs == input.UnitesLegalesRefuseesRcs ||
                    this.UnitesLegalesRefuseesRcs != null &&
                    input.UnitesLegalesRefuseesRcs != null &&
                    this.UnitesLegalesRefuseesRcs.SequenceEqual(input.UnitesLegalesRefuseesRcs)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.UnitesLegalesRefuseesRcs != null)
                {
                    hashCode = (hashCode * 59) + this.UnitesLegalesRefuseesRcs.GetHashCode();
                }
                return hashCode;
            }
        }
