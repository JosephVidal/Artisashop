...
namespace SireneApi.Model
{
    ...
    /// ReponseUniteLegale
    /// </summary>
    [DataContract(Name = "ReponseUniteLegale")]
    public partial class ReponseUniteLegale : IEquatable<ReponseUniteLegale>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReponseUniteLegale" /> class.
        /// </summary>
        /// <param name="header">header.</param>
        /// <param name="uniteLegale">uniteLegale.</param>
        public ReponseUniteLegale(Header header = default(Header), UniteLegale uniteLegale = default(UniteLegale))
        {
            this.Header = header;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReponseUniteLegale {\n");
        ...
        {
            return this.Equals(input as ReponseUniteLegale);
        }

        /// <summary>
        /// Returns true if ReponseUniteLegale instances are equal
        /// </summary>
        /// <param name="input">Instance of ReponseUniteLegale to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReponseUniteLegale input)
        {
            if (input == null)
            {
                return false;
