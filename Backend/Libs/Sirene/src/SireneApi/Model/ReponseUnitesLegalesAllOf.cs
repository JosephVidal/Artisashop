...
namespace SireneApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ReponseUnitesLegales_allOf")]
    public partial class ReponseUnitesLegalesAllOf : IEquatable<ReponseUnitesLegalesAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReponseUnitesLegalesAllOf" /> class.
        /// </summary>
        /// <param name="unitesLegales">unitesLegales.</param>
        /// <param name="facettes">facettes.</param>
        public ReponseUnitesLegalesAllOf(List<UniteLegale> unitesLegales = default(List<UniteLegale>), List<Facette> facettes = default(List<Facette>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReponseUnitesLegalesAllOf {\n");
        ...
        {
            return this.Equals(input as ReponseUnitesLegalesAllOf);
        }

        /// <summary>
        /// Returns true if ReponseUnitesLegalesAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ReponseUnitesLegalesAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReponseUnitesLegalesAllOf input)
        {
            if (input == null)
            {
                return false;
