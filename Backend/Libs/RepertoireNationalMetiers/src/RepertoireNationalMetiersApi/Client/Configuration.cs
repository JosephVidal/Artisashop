...
namespace RepertoireNationalMetiersApi.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://api-rnm.artisanat.fr";
            ...
            {
                {
                    "DefaultApi.V2EntreprisesSirenGet", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
        ...
        public Configuration(
            ...
            string basePath = "https://api-rnm.artisanat.fr") : this()
        {
        ...
        {
            string report = "C# SDK (RepertoireNationalMetiersApi) Debug Report:\n";
