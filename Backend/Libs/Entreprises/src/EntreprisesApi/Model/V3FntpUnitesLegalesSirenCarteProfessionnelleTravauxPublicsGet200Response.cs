...
{
    /// <summary>
    /// V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200Response
    /// </summary>
    [DataContract(Name = "_v3_fntp_unites_legales__siren__carte_professionnelle_travaux_publics_get_200_response")]
    public partial class V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200Response : IEquatable<V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200Response" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200Response(V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200ResponseData data = default(V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200ResponseData))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200Response and cannot be null");
            }
            this.Data = data;
        }
        ...
        public V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200ResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200Response {\n");
        ...
        {
            return this.Equals(input as V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200Response);
        }

        /// <summary>
        /// Returns true if V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3FntpUnitesLegalesSirenCarteProfessionnelleTravauxPublicsGet200Response input)
        {
            if (input == null)
            {
                return false;
