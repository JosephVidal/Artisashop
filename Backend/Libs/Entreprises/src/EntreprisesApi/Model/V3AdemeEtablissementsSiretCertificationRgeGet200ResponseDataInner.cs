...
{
    /// <summary>
    /// V3AdemeEtablissementsSiretCertificationRgeGet200ResponseDataInner
    /// </summary>
    [DataContract(Name = "_v3_ademe_etablissements__siret__certification_rge_get_200_response_data_inner")]
    public partial class V3AdemeEtablissementsSiretCertificationRgeGet200ResponseDataInner : IEquatable<V3AdemeEtablissementsSiretCertificationRgeGet200ResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3AdemeEtablissementsSiretCertificationRgeGet200ResponseDataInner" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public V3AdemeEtablissementsSiretCertificationRgeGet200ResponseDataInner(V3AdemeEtablissementsSiretCertificationRgeGet200ResponseDataInnerData data = default(V3AdemeEtablissementsSiretCertificationRgeGet200ResponseDataInnerData))
        {
            this.Data = data;
        }
        ...
        public V3AdemeEtablissementsSiretCertificationRgeGet200ResponseDataInnerData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3AdemeEtablissementsSiretCertificationRgeGet200ResponseDataInner {\n");
        ...
        {
            return this.Equals(input as V3AdemeEtablissementsSiretCertificationRgeGet200ResponseDataInner);
        }

        /// <summary>
        /// Returns true if V3AdemeEtablissementsSiretCertificationRgeGet200ResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of V3AdemeEtablissementsSiretCertificationRgeGet200ResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3AdemeEtablissementsSiretCertificationRgeGet200ResponseDataInner input)
        {
            if (input == null)
            {
                return false;
