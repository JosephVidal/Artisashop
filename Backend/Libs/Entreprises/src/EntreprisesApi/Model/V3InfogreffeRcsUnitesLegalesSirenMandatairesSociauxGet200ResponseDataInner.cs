...
{
    /// <summary>
    /// V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200ResponseDataInner
    /// </summary>
    [DataContract(Name = "_v3_infogreffe_rcs_unites_legales__siren__mandataires_sociaux_get_200_response_data_inner")]
    public partial class V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200ResponseDataInner : IEquatable<V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200ResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200ResponseDataInner" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200ResponseDataInner(V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200ResponseDataInnerData data = default(V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200ResponseDataInnerData))
        {
            this.Data = data;
        }
        ...
        public V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200ResponseDataInnerData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200ResponseDataInner {\n");
        ...
        {
            return this.Equals(input as V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200ResponseDataInner);
        }

        /// <summary>
        /// Returns true if V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200ResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200ResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3InfogreffeRcsUnitesLegalesSirenMandatairesSociauxGet200ResponseDataInner input)
        {
            if (input == null)
            {
                return false;
