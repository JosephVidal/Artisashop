...
{
    /// <summary>
    /// V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200ResponseDataInner
    /// </summary>
    [DataContract(Name = "_v3_ministere_interieur_rna_associations__siret_or_rna__documents_get_200_response_data_inner")]
    public partial class V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200ResponseDataInner : IEquatable<V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200ResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200ResponseDataInner" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200ResponseDataInner(V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200ResponseDataInnerData data = default(V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200ResponseDataInnerData))
        {
            this.Data = data;
        }
        ...
        public V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200ResponseDataInnerData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200ResponseDataInner {\n");
        ...
        {
            return this.Equals(input as V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200ResponseDataInner);
        }

        /// <summary>
        /// Returns true if V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200ResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200ResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3MinistereInterieurRnaAssociationsSiretOrRnaDocumentsGet200ResponseDataInner input)
        {
            if (input == null)
            {
                return false;
