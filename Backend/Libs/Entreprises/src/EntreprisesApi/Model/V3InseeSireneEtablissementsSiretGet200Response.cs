...
{
    /// <summary>
    /// V3InseeSireneEtablissementsSiretGet200Response
    /// </summary>
    [DataContract(Name = "_v3_insee_sirene_etablissements__siret__get_200_response")]
    public partial class V3InseeSireneEtablissementsSiretGet200Response : IEquatable<V3InseeSireneEtablissementsSiretGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InseeSireneEtablissementsSiretGet200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3InseeSireneEtablissementsSiretGet200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InseeSireneEtablissementsSiretGet200Response" /> class.
        /// </summary>
        ...
        public V3InseeSireneEtablissementsSiretGet200Response(V3InseeSireneEtablissementsSiretGet200ResponseData data = default(V3InseeSireneEtablissementsSiretGet200ResponseData), V3InseeSireneEtablissementsSiretGet200ResponseLinks links = default(V3InseeSireneEtablissementsSiretGet200ResponseLinks), V3InseeSireneEtablissementsSiretAdresseGet200ResponseMeta meta = default(V3InseeSireneEtablissementsSiretAdresseGet200ResponseMeta))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for V3InseeSireneEtablissementsSiretGet200Response and cannot be null");
            }
            this.Data = data;
            // to ensure "links" is required (not null)
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for V3InseeSireneEtablissementsSiretGet200Response and cannot be null");
            }
            this.Links = links;
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new ArgumentNullException("meta is a required property for V3InseeSireneEtablissementsSiretGet200Response and cannot be null");
            }
            this.Meta = meta;
        }
        ...
        public V3InseeSireneEtablissementsSiretGet200ResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3InseeSireneEtablissementsSiretGet200Response {\n");
        ...
        {
            return this.Equals(input as V3InseeSireneEtablissementsSiretGet200Response);
        }

        /// <summary>
        /// Returns true if V3InseeSireneEtablissementsSiretGet200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of V3InseeSireneEtablissementsSiretGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3InseeSireneEtablissementsSiretGet200Response input)
        {
            if (input == null)
            {
                return false;
