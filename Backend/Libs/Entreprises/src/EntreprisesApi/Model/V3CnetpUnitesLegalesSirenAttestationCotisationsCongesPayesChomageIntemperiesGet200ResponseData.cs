...
{
    /// <summary>
    /// V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200ResponseData
    /// </summary>
    [DataContract(Name = "_v3_cnetp_unites_legales__siren__attestation_cotisations_conges_payes_chomage_intemperies_get_200_response_data")]
    public partial class V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200ResponseData : IEquatable<V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200ResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200ResponseData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200ResponseData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200ResponseData" /> class.
        /// </summary>
        /// <param name="documentUrl">Ce document est automatiquement supprimé au bout de 3 mois. (required).</param>
        ...
        public V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200ResponseData(string documentUrl = default(string), int expiresIn = default(int))
        {
            // to ensure "documentUrl" is required (not null)
            if (documentUrl == null)
            {
                throw new ArgumentNullException("documentUrl is a required property for V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200ResponseData and cannot be null");
            }
        ...
        /// <summary>
        /// Ce document est automatiquement supprimé au bout de 3 mois.
        /// </summary>
        /// <value>Ce document est automatiquement supprimé au bout de 3 mois.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200ResponseData {\n");
        ...
        {
            return this.Equals(input as V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200ResponseData);
        }

        /// <summary>
        /// Returns true if V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200ResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200ResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200ResponseData input)
        {
            if (input == null)
            {
                return false;
