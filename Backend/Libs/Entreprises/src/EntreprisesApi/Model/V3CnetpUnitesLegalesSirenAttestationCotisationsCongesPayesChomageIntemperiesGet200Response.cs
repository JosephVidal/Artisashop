...
{
    /// <summary>
    /// V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200Response
    /// </summary>
    [DataContract(Name = "_v3_cnetp_unites_legales__siren__attestation_cotisations_conges_payes_chomage_intemperies_get_200_response")]
    public partial class V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200Response : IEquatable<V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200Response" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200Response(V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200ResponseData data = default(V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200ResponseData))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200Response and cannot be null");
            }
            this.Data = data;
        }
        ...
        public V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200ResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200Response {\n");
        ...
        {
            return this.Equals(input as V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200Response);
        }

        /// <summary>
        /// Returns true if V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3CnetpUnitesLegalesSirenAttestationCotisationsCongesPayesChomageIntemperiesGet200Response input)
        {
            if (input == null)
            {
                return false;
