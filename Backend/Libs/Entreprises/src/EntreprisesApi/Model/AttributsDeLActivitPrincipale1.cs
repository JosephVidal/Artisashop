...
{
    /// <summary>
    /// AttributsDeLActivitPrincipale1
    /// </summary>
    [DataContract(Name = "Attributs_de_l_activit__principale_1")]
    public partial class AttributsDeLActivitPrincipale1 : IEquatable<AttributsDeLActivitPrincipale1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AttributsDeLActivitPrincipale1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AttributsDeLActivitPrincipale1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AttributsDeLActivitPrincipale1" /> class.
        /// </summary>
        /// <param name="code">Le code APE (activité principale exercée) permet d&#39;identifier la branche d&#39;activité principale. Il est attribué par l&#39;Insee lors de l&#39;immatriculation ou la déclaration d&#39;activité de l&#39;entreprise. Ce code de 4 chiffres + 1 lettre est extrait de la nomenclature d&#39;activité française (NAF) de l&#39;Insee.     À noter qu&#39;une entreprise n&#39;ayant pas encore de code APE peut se voir affecter la valeur &#39;00.00Z&#39; de manière provisoire.     Plus d&#39;informations métier : https://entreprendre.service-public.fr/vosdroits/F33050 Nomemclature d&#39;activité française - NAF rév.2 de l&#39;Insee : https://www.insee.fr/fr/information/2120875 (required).</param>
        /// <param name="libelle">Si le code n&#39;est pas renseigné dans la nomenclature &#39;Naf Rév2&#39; (nomenclature en vigueur), le libellé n&#39;est pas renseigné ici. Si le code ne correspond à aucun libellé au sein de la nomenclature &#39;Naf Rév2&#39;, la valeur &#39;non référencé&#39; est utilisée.     Nomemclature d&#39;activité française - NAF rév.2 de l&#39;Insee : https://www.insee.fr/fr/information/2406147 (required).</param>
        /// <param name="nomenclature">Ce champ indique le nom de la nomenclature associée au code APE. (required).</param>
        public AttributsDeLActivitPrincipale1(string code = default(string), string libelle = default(string), string nomenclature = default(string))
        {
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for AttributsDeLActivitPrincipale1 and cannot be null");
            }
            this.Code = code;
            // to ensure "libelle" is required (not null)
            if (libelle == null)
            {
                throw new ArgumentNullException("libelle is a required property for AttributsDeLActivitPrincipale1 and cannot be null");
            }
            this.Libelle = libelle;
            // to ensure "nomenclature" is required (not null)
            if (nomenclature == null)
            {
                throw new ArgumentNullException("nomenclature is a required property for AttributsDeLActivitPrincipale1 and cannot be null");
            }
        ...
        /// <summary>
        /// Si le code n&#39;est pas renseigné dans la nomenclature &#39;Naf Rév2&#39; (nomenclature en vigueur), le libellé n&#39;est pas renseigné ici. Si le code ne correspond à aucun libellé au sein de la nomenclature &#39;Naf Rév2&#39;, la valeur &#39;non référencé&#39; est utilisée.     Nomemclature d&#39;activité française - NAF rév.2 de l&#39;Insee : https://www.insee.fr/fr/information/2406147
        /// </summary>
        /// <value>Si le code n&#39;est pas renseigné dans la nomenclature &#39;Naf Rév2&#39; (nomenclature en vigueur), le libellé n&#39;est pas renseigné ici. Si le code ne correspond à aucun libellé au sein de la nomenclature &#39;Naf Rév2&#39;, la valeur &#39;non référencé&#39; est utilisée.     Nomemclature d&#39;activité française - NAF rév.2 de l&#39;Insee : https://www.insee.fr/fr/information/2406147</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AttributsDeLActivitPrincipale1 {\n");
        ...
        {
            return this.Equals(input as AttributsDeLActivitPrincipale1);
        }

        /// <summary>
        /// Returns true if AttributsDeLActivitPrincipale1 instances are equal
        /// </summary>
        /// <param name="input">Instance of AttributsDeLActivitPrincipale1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AttributsDeLActivitPrincipale1 input)
        {
            if (input == null)
            {
                return false;
