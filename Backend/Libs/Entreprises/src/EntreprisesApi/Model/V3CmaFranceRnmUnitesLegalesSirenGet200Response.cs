...
{
    /// <summary>
    /// V3CmaFranceRnmUnitesLegalesSirenGet200Response
    /// </summary>
    [DataContract(Name = "_v3_cma_france_rnm_unites_legales__siren__get_200_response")]
    public partial class V3CmaFranceRnmUnitesLegalesSirenGet200Response : IEquatable<V3CmaFranceRnmUnitesLegalesSirenGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3CmaFranceRnmUnitesLegalesSirenGet200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3CmaFranceRnmUnitesLegalesSirenGet200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3CmaFranceRnmUnitesLegalesSirenGet200Response" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public V3CmaFranceRnmUnitesLegalesSirenGet200Response(V3CmaFranceRnmUnitesLegalesSirenGet200ResponseData data = default(V3CmaFranceRnmUnitesLegalesSirenGet200ResponseData))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for V3CmaFranceRnmUnitesLegalesSirenGet200Response and cannot be null");
            }
            this.Data = data;
        }
        ...
        public V3CmaFranceRnmUnitesLegalesSirenGet200ResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3CmaFranceRnmUnitesLegalesSirenGet200Response {\n");
        ...
        {
            return this.Equals(input as V3CmaFranceRnmUnitesLegalesSirenGet200Response);
        }

        /// <summary>
        /// Returns true if V3CmaFranceRnmUnitesLegalesSirenGet200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of V3CmaFranceRnmUnitesLegalesSirenGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3CmaFranceRnmUnitesLegalesSirenGet200Response input)
        {
            if (input == null)
            {
                return false;
