...
{
    /// <summary>
    /// V3InpiUnitesLegalesSirenBrevetsGet200ResponseDataInner
    /// </summary>
    [DataContract(Name = "_v3_inpi_unites_legales__siren__brevets_get_200_response_data_inner")]
    public partial class V3InpiUnitesLegalesSirenBrevetsGet200ResponseDataInner : IEquatable<V3InpiUnitesLegalesSirenBrevetsGet200ResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InpiUnitesLegalesSirenBrevetsGet200ResponseDataInner" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public V3InpiUnitesLegalesSirenBrevetsGet200ResponseDataInner(V3InpiUnitesLegalesSirenBrevetsGet200ResponseDataInnerData data = default(V3InpiUnitesLegalesSirenBrevetsGet200ResponseDataInnerData))
        {
            this.Data = data;
        }
        ...
        public V3InpiUnitesLegalesSirenBrevetsGet200ResponseDataInnerData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3InpiUnitesLegalesSirenBrevetsGet200ResponseDataInner {\n");
        ...
        {
            return this.Equals(input as V3InpiUnitesLegalesSirenBrevetsGet200ResponseDataInner);
        }

        /// <summary>
        /// Returns true if V3InpiUnitesLegalesSirenBrevetsGet200ResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of V3InpiUnitesLegalesSirenBrevetsGet200ResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3InpiUnitesLegalesSirenBrevetsGet200ResponseDataInner input)
        {
            if (input == null)
            {
                return false;
