...
{
    /// <summary>
    /// V3DgfipEtablissementsSiretChiffresAffairesGet200ResponseDataInner
    /// </summary>
    [DataContract(Name = "_v3_dgfip_etablissements__siret__chiffres_affaires_get_200_response_data_inner")]
    public partial class V3DgfipEtablissementsSiretChiffresAffairesGet200ResponseDataInner : IEquatable<V3DgfipEtablissementsSiretChiffresAffairesGet200ResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3DgfipEtablissementsSiretChiffresAffairesGet200ResponseDataInner" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public V3DgfipEtablissementsSiretChiffresAffairesGet200ResponseDataInner(V3DgfipEtablissementsSiretChiffresAffairesGet200ResponseDataInnerData data = default(V3DgfipEtablissementsSiretChiffresAffairesGet200ResponseDataInnerData))
        {
            this.Data = data;
        }
        ...
        public V3DgfipEtablissementsSiretChiffresAffairesGet200ResponseDataInnerData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3DgfipEtablissementsSiretChiffresAffairesGet200ResponseDataInner {\n");
        ...
        {
            return this.Equals(input as V3DgfipEtablissementsSiretChiffresAffairesGet200ResponseDataInner);
        }

        /// <summary>
        /// Returns true if V3DgfipEtablissementsSiretChiffresAffairesGet200ResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of V3DgfipEtablissementsSiretChiffresAffairesGet200ResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3DgfipEtablissementsSiretChiffresAffairesGet200ResponseDataInner input)
        {
            if (input == null)
            {
                return false;
