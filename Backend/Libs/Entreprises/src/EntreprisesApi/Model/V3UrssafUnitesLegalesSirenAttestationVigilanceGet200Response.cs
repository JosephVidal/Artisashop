...
{
    /// <summary>
    /// V3UrssafUnitesLegalesSirenAttestationVigilanceGet200Response
    /// </summary>
    [DataContract(Name = "_v3_urssaf_unites_legales__siren__attestation_vigilance_get_200_response")]
    public partial class V3UrssafUnitesLegalesSirenAttestationVigilanceGet200Response : IEquatable<V3UrssafUnitesLegalesSirenAttestationVigilanceGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3UrssafUnitesLegalesSirenAttestationVigilanceGet200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3UrssafUnitesLegalesSirenAttestationVigilanceGet200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3UrssafUnitesLegalesSirenAttestationVigilanceGet200Response" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public V3UrssafUnitesLegalesSirenAttestationVigilanceGet200Response(V3UrssafUnitesLegalesSirenAttestationVigilanceGet200ResponseData data = default(V3UrssafUnitesLegalesSirenAttestationVigilanceGet200ResponseData))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for V3UrssafUnitesLegalesSirenAttestationVigilanceGet200Response and cannot be null");
            }
            this.Data = data;
        }
        ...
        public V3UrssafUnitesLegalesSirenAttestationVigilanceGet200ResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3UrssafUnitesLegalesSirenAttestationVigilanceGet200Response {\n");
        ...
        {
            return this.Equals(input as V3UrssafUnitesLegalesSirenAttestationVigilanceGet200Response);
        }

        /// <summary>
        /// Returns true if V3UrssafUnitesLegalesSirenAttestationVigilanceGet200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of V3UrssafUnitesLegalesSirenAttestationVigilanceGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3UrssafUnitesLegalesSirenAttestationVigilanceGet200Response input)
        {
            if (input == null)
            {
                return false;
