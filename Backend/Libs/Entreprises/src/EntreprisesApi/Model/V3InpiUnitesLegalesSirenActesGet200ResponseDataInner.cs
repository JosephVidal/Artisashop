...
{
    /// <summary>
    /// V3InpiUnitesLegalesSirenActesGet200ResponseDataInner
    /// </summary>
    [DataContract(Name = "_v3_inpi_unites_legales__siren__actes_get_200_response_data_inner")]
    public partial class V3InpiUnitesLegalesSirenActesGet200ResponseDataInner : IEquatable<V3InpiUnitesLegalesSirenActesGet200ResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InpiUnitesLegalesSirenActesGet200ResponseDataInner" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public V3InpiUnitesLegalesSirenActesGet200ResponseDataInner(V3InpiUnitesLegalesSirenActesGet200ResponseDataInnerData data = default(V3InpiUnitesLegalesSirenActesGet200ResponseDataInnerData))
        {
            this.Data = data;
        }
        ...
        public V3InpiUnitesLegalesSirenActesGet200ResponseDataInnerData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3InpiUnitesLegalesSirenActesGet200ResponseDataInner {\n");
        ...
        {
            return this.Equals(input as V3InpiUnitesLegalesSirenActesGet200ResponseDataInner);
        }

        /// <summary>
        /// Returns true if V3InpiUnitesLegalesSirenActesGet200ResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of V3InpiUnitesLegalesSirenActesGet200ResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3InpiUnitesLegalesSirenActesGet200ResponseDataInner input)
        {
            if (input == null)
            {
                return false;
