...
{
    /// <summary>
    /// V3OpqibiUnitesLegalesSirenCertificationIngenierieGet200Response
    /// </summary>
    [DataContract(Name = "_v3_opqibi_unites_legales__siren__certification_ingenierie_get_200_response")]
    public partial class V3OpqibiUnitesLegalesSirenCertificationIngenierieGet200Response : IEquatable<V3OpqibiUnitesLegalesSirenCertificationIngenierieGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3OpqibiUnitesLegalesSirenCertificationIngenierieGet200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3OpqibiUnitesLegalesSirenCertificationIngenierieGet200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3OpqibiUnitesLegalesSirenCertificationIngenierieGet200Response" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public V3OpqibiUnitesLegalesSirenCertificationIngenierieGet200Response(V3OpqibiUnitesLegalesSirenCertificationIngenierieGet200ResponseData data = default(V3OpqibiUnitesLegalesSirenCertificationIngenierieGet200ResponseData))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for V3OpqibiUnitesLegalesSirenCertificationIngenierieGet200Response and cannot be null");
            }
            this.Data = data;
        }
        ...
        public V3OpqibiUnitesLegalesSirenCertificationIngenierieGet200ResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3OpqibiUnitesLegalesSirenCertificationIngenierieGet200Response {\n");
        ...
        {
            return this.Equals(input as V3OpqibiUnitesLegalesSirenCertificationIngenierieGet200Response);
        }

        /// <summary>
        /// Returns true if V3OpqibiUnitesLegalesSirenCertificationIngenierieGet200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of V3OpqibiUnitesLegalesSirenCertificationIngenierieGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3OpqibiUnitesLegalesSirenCertificationIngenierieGet200Response input)
        {
            if (input == null)
            {
                return false;
