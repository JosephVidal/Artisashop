...
{
    /// <summary>
    /// V3InseeSireneEtablissementsDiffusiblesSiretGet200ResponseData
    /// </summary>
    [DataContract(Name = "_v3_insee_sirene_etablissements_diffusibles__siret__get_200_response_data")]
    public partial class V3InseeSireneEtablissementsDiffusiblesSiretGet200ResponseData : IEquatable<V3InseeSireneEtablissementsDiffusiblesSiretGet200ResponseData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Détermine si l&#39;établissement est non-diffusible. Cette API n&#39;appelant pas les non-diffusible, cette valeur est toujours à &#39;true&#39;. Pour récupérer des établissements non-diffusibles, référez-vous à la documentation de l&#39;API /insee/etablissements/:siren
        /// </summary>
        /// <value>Détermine si l&#39;établissement est non-diffusible. Cette API n&#39;appelant pas les non-diffusible, cette valeur est toujours à &#39;true&#39;. Pour récupérer des établissements non-diffusibles, référez-vous à la documentation de l&#39;API /insee/etablissements/:siren</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InseeSireneEtablissementsDiffusiblesSiretGet200ResponseData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3InseeSireneEtablissementsDiffusiblesSiretGet200ResponseData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InseeSireneEtablissementsDiffusiblesSiretGet200ResponseData" /> class.
        /// </summary>
        ...
        /// <param name="diffusableCommercialement">Détermine si l&#39;établissement est non-diffusible. Cette API n&#39;appelant pas les non-diffusible, cette valeur est toujours à &#39;true&#39;. Pour récupérer des établissements non-diffusibles, référez-vous à la documentation de l&#39;API /insee/etablissements/:siren (required).</param>
        ...
        public V3InseeSireneEtablissementsDiffusiblesSiretGet200ResponseData(SiegeSocialEnum siegeSocial = default(SiegeSocialEnum), EtatAdministratifEnum etatAdministratif = default(EtatAdministratifEnum), int? dateFermeture = default(int?), AttributsDeLActivitPrincipale activitePrincipale = default(AttributsDeLActivitPrincipale), TrancheDEffectifSalariDeLTablissement trancheEffectifSalarie = default(TrancheDEffectifSalariDeLTablissement), DiffusableCommercialementEnum diffusableCommercialement = default(DiffusableCommercialementEnum), string enseigne = default(string), UnitLGaleDeLTablissement uniteLegale = default(UnitLGaleDeLTablissement), AdresseDeLTablissement adresse = default(AdresseDeLTablissement), int dateCreation = default(int))
        {
            ...
            {
                throw new ArgumentNullException("dateFermeture is a required property for V3InseeSireneEtablissementsDiffusiblesSiretGet200ResponseData and cannot be null");
            }
            this.DateFermeture = dateFermeture;
            // to ensure "activitePrincipale" is required (not null)
            if (activitePrincipale == null)
            {
                throw new ArgumentNullException("activitePrincipale is a required property for V3InseeSireneEtablissementsDiffusiblesSiretGet200ResponseData and cannot be null");
            }
            this.ActivitePrincipale = activitePrincipale;
            // to ensure "trancheEffectifSalarie" is required (not null)
            if (trancheEffectifSalarie == null)
            {
                throw new ArgumentNullException("trancheEffectifSalarie is a required property for V3InseeSireneEtablissementsDiffusiblesSiretGet200ResponseData and cannot be null");
            }
            ...
            if (enseigne == null)
            {
                throw new ArgumentNullException("enseigne is a required property for V3InseeSireneEtablissementsDiffusiblesSiretGet200ResponseData and cannot be null");
            }
            this.Enseigne = enseigne;
            // to ensure "uniteLegale" is required (not null)
            if (uniteLegale == null)
            {
                throw new ArgumentNullException("uniteLegale is a required property for V3InseeSireneEtablissementsDiffusiblesSiretGet200ResponseData and cannot be null");
            }
            this.UniteLegale = uniteLegale;
            // to ensure "adresse" is required (not null)
            if (adresse == null)
            {
                throw new ArgumentNullException("adresse is a required property for V3InseeSireneEtablissementsDiffusiblesSiretGet200ResponseData and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3InseeSireneEtablissementsDiffusiblesSiretGet200ResponseData {\n");
        ...
        {
            return this.Equals(input as V3InseeSireneEtablissementsDiffusiblesSiretGet200ResponseData);
        }

        /// <summary>
        /// Returns true if V3InseeSireneEtablissementsDiffusiblesSiretGet200ResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of V3InseeSireneEtablissementsDiffusiblesSiretGet200ResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3InseeSireneEtablissementsDiffusiblesSiretGet200ResponseData input)
        {
            if (input == null)
            {
                return false;
