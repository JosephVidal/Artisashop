...
{
    /// <summary>
    /// V3InpiUnitesLegalesSirenModelesGet200ResponseDataInner
    /// </summary>
    [DataContract(Name = "_v3_inpi_unites_legales__siren__modeles_get_200_response_data_inner")]
    public partial class V3InpiUnitesLegalesSirenModelesGet200ResponseDataInner : IEquatable<V3InpiUnitesLegalesSirenModelesGet200ResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InpiUnitesLegalesSirenModelesGet200ResponseDataInner" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        public V3InpiUnitesLegalesSirenModelesGet200ResponseDataInner(V3InpiUnitesLegalesSirenModelesGet200ResponseDataInnerData data = default(V3InpiUnitesLegalesSirenModelesGet200ResponseDataInnerData), V3InpiUnitesLegalesSirenModelesGet200ResponseDataInnerLinks links = default(V3InpiUnitesLegalesSirenModelesGet200ResponseDataInnerLinks))
        {
            this.Data = data;
            this.Links = links;
        }
        ...
        public V3InpiUnitesLegalesSirenModelesGet200ResponseDataInnerData Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name = "links", EmitDefaultValue = false)]
        public V3InpiUnitesLegalesSirenModelesGet200ResponseDataInnerLinks Links { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3InpiUnitesLegalesSirenModelesGet200ResponseDataInner {\n");
        ...
        {
            return this.Equals(input as V3InpiUnitesLegalesSirenModelesGet200ResponseDataInner);
        }

        /// <summary>
        /// Returns true if V3InpiUnitesLegalesSirenModelesGet200ResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of V3InpiUnitesLegalesSirenModelesGet200ResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3InpiUnitesLegalesSirenModelesGet200ResponseDataInner input)
        {
            if (input == null)
            {
                return false;
