...
{
    /// <summary>
    /// V3DgfipUnitesLegalesSirenAttestationFiscaleGet200ResponseData
    /// </summary>
    [DataContract(Name = "_v3_dgfip_unites_legales__siren__attestation_fiscale_get_200_response_data")]
    public partial class V3DgfipUnitesLegalesSirenAttestationFiscaleGet200ResponseData : IEquatable<V3DgfipUnitesLegalesSirenAttestationFiscaleGet200ResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3DgfipUnitesLegalesSirenAttestationFiscaleGet200ResponseData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3DgfipUnitesLegalesSirenAttestationFiscaleGet200ResponseData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3DgfipUnitesLegalesSirenAttestationFiscaleGet200ResponseData" /> class.
        /// </summary>
        /// <param name="documentUrl">Ce lien donne accès à l&#39;attestation fiscale, au format PDF. L&#39;attestation, toujours datée du 31/12 de l’année précédente, atteste que l&#39;entreprise est à jour de ses obligations fiscales jusqu&#39;à cette date.     Par exemple, vous appelez l&#39;API en mars 2022, l’attestation fiscale renvoyée indique que l’entreprise est à jour de ses obligations fiscales lui incombant au 31/12/2021.     L’attestation fiscale est valide un an sur une année civile (jusqu’au 31/12/AAAA). (required).</param>
        /// <param name="expiresIn">Nombre de secondes avant l&#39;expiration de l&#39;url associée à l&#39;attribut document_url : cette durée correspond généralement à 3 mois. (required).</param>
        public V3DgfipUnitesLegalesSirenAttestationFiscaleGet200ResponseData(string documentUrl = default(string), int expiresIn = default(int))
        {
            // to ensure "documentUrl" is required (not null)
            if (documentUrl == null)
            {
                throw new ArgumentNullException("documentUrl is a required property for V3DgfipUnitesLegalesSirenAttestationFiscaleGet200ResponseData and cannot be null");
            }
        ...
        /// <summary>
        /// Ce lien donne accès à l&#39;attestation fiscale, au format PDF. L&#39;attestation, toujours datée du 31/12 de l’année précédente, atteste que l&#39;entreprise est à jour de ses obligations fiscales jusqu&#39;à cette date.     Par exemple, vous appelez l&#39;API en mars 2022, l’attestation fiscale renvoyée indique que l’entreprise est à jour de ses obligations fiscales lui incombant au 31/12/2021.     L’attestation fiscale est valide un an sur une année civile (jusqu’au 31/12/AAAA).
        /// </summary>
        /// <value>Ce lien donne accès à l&#39;attestation fiscale, au format PDF. L&#39;attestation, toujours datée du 31/12 de l’année précédente, atteste que l&#39;entreprise est à jour de ses obligations fiscales jusqu&#39;à cette date.     Par exemple, vous appelez l&#39;API en mars 2022, l’attestation fiscale renvoyée indique que l’entreprise est à jour de ses obligations fiscales lui incombant au 31/12/2021.     L’attestation fiscale est valide un an sur une année civile (jusqu’au 31/12/AAAA).</value>
        [DataMember(Name = "document_url", IsRequired = true, EmitDefaultValue = true)]
        public string DocumentUrl { get; set; }

        /// <summary>
        /// Nombre de secondes avant l&#39;expiration de l&#39;url associée à l&#39;attribut document_url : cette durée correspond généralement à 3 mois.
        /// </summary>
        /// <value>Nombre de secondes avant l&#39;expiration de l&#39;url associée à l&#39;attribut document_url : cette durée correspond généralement à 3 mois.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3DgfipUnitesLegalesSirenAttestationFiscaleGet200ResponseData {\n");
        ...
        {
            return this.Equals(input as V3DgfipUnitesLegalesSirenAttestationFiscaleGet200ResponseData);
        }

        /// <summary>
        /// Returns true if V3DgfipUnitesLegalesSirenAttestationFiscaleGet200ResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of V3DgfipUnitesLegalesSirenAttestationFiscaleGet200ResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3DgfipUnitesLegalesSirenAttestationFiscaleGet200ResponseData input)
        {
            if (input == null)
            {
                return false;
