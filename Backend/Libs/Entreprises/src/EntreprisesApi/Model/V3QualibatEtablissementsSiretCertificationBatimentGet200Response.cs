...
{
    /// <summary>
    /// V3QualibatEtablissementsSiretCertificationBatimentGet200Response
    /// </summary>
    [DataContract(Name = "_v3_qualibat_etablissements__siret__certification_batiment_get_200_response")]
    public partial class V3QualibatEtablissementsSiretCertificationBatimentGet200Response : IEquatable<V3QualibatEtablissementsSiretCertificationBatimentGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3QualibatEtablissementsSiretCertificationBatimentGet200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3QualibatEtablissementsSiretCertificationBatimentGet200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3QualibatEtablissementsSiretCertificationBatimentGet200Response" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public V3QualibatEtablissementsSiretCertificationBatimentGet200Response(V3QualibatEtablissementsSiretCertificationBatimentGet200ResponseData data = default(V3QualibatEtablissementsSiretCertificationBatimentGet200ResponseData))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for V3QualibatEtablissementsSiretCertificationBatimentGet200Response and cannot be null");
            }
            this.Data = data;
        }
        ...
        public V3QualibatEtablissementsSiretCertificationBatimentGet200ResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3QualibatEtablissementsSiretCertificationBatimentGet200Response {\n");
        ...
        {
            return this.Equals(input as V3QualibatEtablissementsSiretCertificationBatimentGet200Response);
        }

        /// <summary>
        /// Returns true if V3QualibatEtablissementsSiretCertificationBatimentGet200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of V3QualibatEtablissementsSiretCertificationBatimentGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3QualibatEtablissementsSiretCertificationBatimentGet200Response input)
        {
            if (input == null)
            {
                return false;
