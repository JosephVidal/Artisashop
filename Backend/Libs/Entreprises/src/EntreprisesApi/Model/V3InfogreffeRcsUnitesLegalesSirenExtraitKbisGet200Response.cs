...
{
    /// <summary>
    /// V3InfogreffeRcsUnitesLegalesSirenExtraitKbisGet200Response
    /// </summary>
    [DataContract(Name = "_v3_infogreffe_rcs_unites_legales__siren__extrait_kbis_get_200_response")]
    public partial class V3InfogreffeRcsUnitesLegalesSirenExtraitKbisGet200Response : IEquatable<V3InfogreffeRcsUnitesLegalesSirenExtraitKbisGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InfogreffeRcsUnitesLegalesSirenExtraitKbisGet200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3InfogreffeRcsUnitesLegalesSirenExtraitKbisGet200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InfogreffeRcsUnitesLegalesSirenExtraitKbisGet200Response" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public V3InfogreffeRcsUnitesLegalesSirenExtraitKbisGet200Response(V3InfogreffeRcsUnitesLegalesSirenExtraitKbisGet200ResponseData data = default(V3InfogreffeRcsUnitesLegalesSirenExtraitKbisGet200ResponseData))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for V3InfogreffeRcsUnitesLegalesSirenExtraitKbisGet200Response and cannot be null");
            }
            this.Data = data;
        }
        ...
        public V3InfogreffeRcsUnitesLegalesSirenExtraitKbisGet200ResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3InfogreffeRcsUnitesLegalesSirenExtraitKbisGet200Response {\n");
        ...
        {
            return this.Equals(input as V3InfogreffeRcsUnitesLegalesSirenExtraitKbisGet200Response);
        }

        /// <summary>
        /// Returns true if V3InfogreffeRcsUnitesLegalesSirenExtraitKbisGet200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of V3InfogreffeRcsUnitesLegalesSirenExtraitKbisGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3InfogreffeRcsUnitesLegalesSirenExtraitKbisGet200Response input)
        {
            if (input == null)
            {
                return false;
