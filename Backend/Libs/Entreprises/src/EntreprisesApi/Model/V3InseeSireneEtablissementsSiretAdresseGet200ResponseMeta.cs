...
namespace EntreprisesApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_v3_insee_sirene_etablissements__siret__adresse_get_200_response_meta")]
    public partial class V3InseeSireneEtablissementsSiretAdresseGet200ResponseMeta : IEquatable<V3InseeSireneEtablissementsSiretAdresseGet200ResponseMeta>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InseeSireneEtablissementsSiretAdresseGet200ResponseMeta" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3InseeSireneEtablissementsSiretAdresseGet200ResponseMeta() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3InseeSireneEtablissementsSiretAdresseGet200ResponseMeta" /> class.
        /// </summary>
        /// <param name="dateDerniereMiseAJour">Date de la dernière mise à jour à l&#39;Insee. (required).</param>
        public V3InseeSireneEtablissementsSiretAdresseGet200ResponseMeta(int dateDerniereMiseAJour = default(int))
        {
        ...
        /// </summary>
        /// <value>Date de la dernière mise à jour à l&#39;Insee.</value>
        [DataMember(Name = "date_derniere_mise_a_jour", IsRequired = true, EmitDefaultValue = true)]
        public int DateDerniereMiseAJour { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3InseeSireneEtablissementsSiretAdresseGet200ResponseMeta {\n");
            sb.Append("  DateDerniereMiseAJour: ").Append(DateDerniereMiseAJour).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as V3InseeSireneEtablissementsSiretAdresseGet200ResponseMeta);
        }

        /// <summary>
        /// Returns true if V3InseeSireneEtablissementsSiretAdresseGet200ResponseMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of V3InseeSireneEtablissementsSiretAdresseGet200ResponseMeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3InseeSireneEtablissementsSiretAdresseGet200ResponseMeta input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.DateDerniereMiseAJour == input.DateDerniereMiseAJour ||
                    this.DateDerniereMiseAJour.Equals(input.DateDerniereMiseAJour)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = (hashCode * 59) + this.DateDerniereMiseAJour.GetHashCode();
                return hashCode;
            }
        }
