...
{
    /// <summary>
    /// V3DgfipUnitesLegalesSirenAttestationFiscaleGet200Response
    /// </summary>
    [DataContract(Name = "_v3_dgfip_unites_legales__siren__attestation_fiscale_get_200_response")]
    public partial class V3DgfipUnitesLegalesSirenAttestationFiscaleGet200Response : IEquatable<V3DgfipUnitesLegalesSirenAttestationFiscaleGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3DgfipUnitesLegalesSirenAttestationFiscaleGet200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3DgfipUnitesLegalesSirenAttestationFiscaleGet200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3DgfipUnitesLegalesSirenAttestationFiscaleGet200Response" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public V3DgfipUnitesLegalesSirenAttestationFiscaleGet200Response(V3DgfipUnitesLegalesSirenAttestationFiscaleGet200ResponseData data = default(V3DgfipUnitesLegalesSirenAttestationFiscaleGet200ResponseData))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for V3DgfipUnitesLegalesSirenAttestationFiscaleGet200Response and cannot be null");
            }
            this.Data = data;
        }
        ...
        public V3DgfipUnitesLegalesSirenAttestationFiscaleGet200ResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V3DgfipUnitesLegalesSirenAttestationFiscaleGet200Response {\n");
        ...
        {
            return this.Equals(input as V3DgfipUnitesLegalesSirenAttestationFiscaleGet200Response);
        }

        /// <summary>
        /// Returns true if V3DgfipUnitesLegalesSirenAttestationFiscaleGet200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of V3DgfipUnitesLegalesSirenAttestationFiscaleGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3DgfipUnitesLegalesSirenAttestationFiscaleGet200Response input)
        {
            if (input == null)
            {
                return false;
